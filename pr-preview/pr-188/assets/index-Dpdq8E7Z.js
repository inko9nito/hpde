 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var vh;function np(){return vh||(vh=1,(function(r){function c(_,K){var it=_.length;_.push(K);t:for(;0<it;){var Tt=it-1>>>1,St=_[Tt];if(0<f(St,K))_[Tt]=K,_[it]=St,it=Tt;else break t}}function d(_){return _.length===0?null:_[0]}function o(_){if(_.length===0)return null;var K=_[0],it=_.pop();if(it!==K){_[0]=it;t:for(var Tt=0,St=_.length,w=St>>>1;Tt<w;){var U=2*(Tt+1)-1,Q=_[U],tt=U+1,rt=_[tt];if(0>f(Q,it))tt<St&&0>f(rt,Q)?(_[Tt]=rt,_[tt]=it,Tt=tt):(_[Tt]=Q,_[U]=it,Tt=U);else if(tt<St&&0>f(rt,it))_[Tt]=rt,_[tt]=it,Tt=tt;else break t}}return K}function f(_,K){var it=_.sortIndex-K.sortIndex;return it!==0?it:_.id-K.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var h=performance;r.unstable_now=function(){return h.now()}}else{var y=Date,S=y.now();r.unstable_now=function(){return y.now()-S}}var m=[],v=[],k=1,C=null,H=3,B=!1,Z=!1,L=!1,j=!1,G=typeof setTimeout=="function"?setTimeout:null,z=typeof clearTimeout=="function"?clearTimeout:null,D=typeof setImmediate<"u"?setImmediate:null;function Y(_){for(var K=d(v);K!==null;){if(K.callback===null)o(v);else if(K.startTime<=_)o(v),K.sortIndex=K.expirationTime,c(m,K);else break;K=d(v)}}function F(_){if(L=!1,Y(_),!Z)if(d(m)!==null)Z=!0,X||(X=!0,$());else{var K=d(v);K!==null&&Ut(F,K.startTime-_)}}var X=!1,q=-1,J=5,I=-1;function at(){return j?!0:!(r.unstable_now()-I<J)}function P(){if(j=!1,X){var _=r.unstable_now();I=_;var K=!0;try{t:{Z=!1,L&&(L=!1,z(q),q=-1),B=!0;var it=H;try{e:{for(Y(_),C=d(m);C!==null&&!(C.expirationTime>_&&at());){var Tt=C.callback;if(typeof Tt=="function"){C.callback=null,H=C.priorityLevel;var St=Tt(C.expirationTime<=_);if(_=r.unstable_now(),typeof St=="function"){C.callback=St,Y(_),K=!0;break e}C===d(m)&&o(m),Y(_)}else o(m);C=d(m)}if(C!==null)K=!0;else{var w=d(v);w!==null&&Ut(F,w.startTime-_),K=!1}}break t}finally{C=null,H=it,B=!1}K=void 0}}finally{K?$():X=!1}}}var $;if(typeof D=="function")$=function(){D(P)};else if(typeof MessageChannel<"u"){var V=new MessageChannel,et=V.port2;V.port1.onmessage=P,$=function(){et.postMessage(null)}}else $=function(){G(P,0)};function Ut(_,K){q=G(function(){_(r.unstable_now())},K)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(_){_.callback=null},r.unstable_forceFrameRate=function(_){0>_||125<_?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):J=0<_?Math.floor(1e3/_):5},r.unstable_getCurrentPriorityLevel=function(){return H},r.unstable_next=function(_){switch(H){case 1:case 2:case 3:var K=3;break;default:K=H}var it=H;H=K;try{return _()}finally{H=it}},r.unstable_requestPaint=function(){j=!0},r.unstable_runWithPriority=function(_,K){switch(_){case 1:case 2:case 3:case 4:case 5:break;default:_=3}var it=H;H=_;try{return K()}finally{H=it}},r.unstable_scheduleCallback=function(_,K,it){var Tt=r.unstable_now();switch(typeof it=="object"&&it!==null?(it=it.delay,it=typeof it=="number"&&0<it?Tt+it:Tt):it=Tt,_){case 1:var St=-1;break;case 2:St=250;break;case 5:St=1073741823;break;case 4:St=1e4;break;default:St=5e3}return St=it+St,_={id:k++,callback:K,priorityLevel:_,startTime:it,expirationTime:St,sortIndex:-1},it>Tt?(_.sortIndex=it,c(v,_),d(m)===null&&_===d(v)&&(L?(z(q),q=-1):L=!0,Ut(F,it-Tt))):(_.sortIndex=St,c(m,_),Z||B||(Z=!0,X||(X=!0,$()))),_},r.unstable_shouldYield=at,r.unstable_wrapCallback=function(_){var K=H;return function(){var it=H;H=K;try{return _.apply(this,arguments)}finally{H=it}}}})(_r)),_r}var bh;function ap(){return bh||(bh=1,Cr.exports=np()),Cr.exports}var Mr={exports:{}},Pt={};/**
 * @license React
...
`,fu="/hpde/pr-preview/pr-188/assets/msrc-1-7-D9G0r_nf.jpg",by={...La("2026-09-11_msrc-1-7",vy),mapImage:fu},wy=`# SCCA at MSRC 1.7 CW
...
`,Ny="/hpde/pr-preview/pr-188/assets/msrc-3-1-BsOP6CK2.png",Ay={...La("2025-11-07_msrc-3-1",Ey),mapImage:Ny},Cy=`# TDE at ECR 2.7
...
`,_y="/hpde/pr-preview/pr-188/assets/ecr-BW_3Ndfh.png",My={...La("2026-05-30_ecr-2-7",Cy),mapImage:_y},Dy=`# Test Event
