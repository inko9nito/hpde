 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ch;function G0(){if(ch)return ot;ch=1;var r=Symbol.for("react.transitional.element"),f=Symbol.for("react.portal"),h=Symbol.for("react.fragment"),o=Symbol.for("react.strict_mode"),c=Symbol.for("react.profiler"),d=Symbol.for("react.consumer"),b=Symbol.for("react.context"),T=Symbol.for("react.forward_ref"),g=Symbol.for("react.suspense"),y=Symbol.for("react.memo"),z=Symbol.for("react.lazy"),k=Symbol.for("react.activity"),O=Symbol.iterator;function U(w){return w===null||typeof w!="object"?null:(w=O&&w[O]||w["@@iterator"],typeof w=="function"?w:null)}var L={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},Z=Object.assign,J={};function q(w,R,G){this.props=w,this.context=R,this.refs=J,this.updater=G||L}q.prototype.isReactComponent={},q.prototype.setState=function(w,R){if(typeof w!="object"&&typeof w!="function"&&w!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,w,R,"setState")},q.prototype.forceUpdate=function(w){this.updater.enqueueForceUpdate(this,w,"forceUpdate")};function H(){}H.prototype=q.prototype;function Y(w,R,G){this.props=w,this.context=R,this.refs=J,this.updater=G||L}var K=Y.prototype=new H;K.constructor=Y,Z(K,q.prototype),K.isPureReactComponent=!0;var ct=Array.isArray;function V(){}var j={H:null,A:null,T:null,S:null},B=Object.prototype.hasOwnProperty;function X(w,R,G){var F=G.ref;return{$$typeof:r,type:w,key:R,ref:F!==void 0?F:null,props:G}}function nt(w,R){return X(w.type,R,w.props)}function P(w){return typeof w=="object"&&w!==null&&w.$$typeof===r}function W(w){var R={"=":"=0",":":"=2"};return"$"+w.replace(/[=:]/g,function(G){return R[G]})}var tt=/\/+/g;function it(w,R){return typeof w=="object"&&w!==null&&w.key!=null?W(""+w.key):R.toString(36)}function Lt(w){switch(w.status){case"fulfilled":return w.value;case"rejected":throw w.reason;default:switch(typeof w.status=="string"?w.then(V,V):(w.status="pending",w.then(function(R){w.status==="pending"&&(w.status="fulfilled",w.value=R)},function(R){w.status==="pending"&&(w.status="rejected",w.reason=R)})),w.status){case"fulfilled":return w.value;case"rejected":throw w.reason}}throw w}function N(w,R,G,F,ut){var ft=typeof w;(ft==="undefined"||ft==="boolean")&&(w=null);var dt=!1;if(w===null)dt=!0;else switch(ft){case"bigint":case"string":case"number":dt=!0;break;case"object":switch(w.$$typeof){case r:case f:dt=!0;break;case z:return dt=w._init,N(dt(w._payload),R,G,F,ut)}}if(dt)return ut=ut(w),dt=F===""?"."+it(w,0):F,ct(ut)?(G="",dt!=null&&(G=dt.replace(tt,"$&/")+"/"),N(ut,R,G,"",function(He){return He})):ut!=null&&(P(ut)&&(ut=nt(ut,G+(ut.key==null||w&&w.key===ut.key?"":(""+ut.key).replace(tt,"$&/")+"/")+dt)),R.push(ut)),1;dt=0;var Rt=F===""?".":F+":";if(ct(w))for(var Ct=0;Ct<w.length;Ct++)F=w[Ct],ft=Rt+it(F,Ct),dt+=N(F,R,G,ft,ut);else if(Ct=U(w),typeof Ct=="function")for(w=Ct.call(w),Ct=0;!(F=w.next()).done;)F=F.value,ft=Rt+it(F,Ct++),dt+=N(F,R,G,ft,ut);else if(ft==="object"){if(typeof w.then=="function")return N(Lt(w),R,G,F,ut);throw R=String(w),Error("Objects are not valid as a React child (found: "+(R==="[object Object]"?"object with keys {"+Object.keys(w).join(", ")+"}":R)+"). If you meant to render a collection of children, use an array instead.")}return dt}function Q(w,R,G){if(w==null)return w;var F=[],ut=0;return N(w,F,"","",function(ft){return R.call(G,ft,ut++)}),F}function at(w){if(w._status===-1){var R=w._result;R=R(),R.then(function(G){(w._status===0||w._status===-1)&&(w._status=1,w._result=G)},function(G){(w._status===0||w._status===-1)&&(w._status=2,w._result=G)}),w._status===-1&&(w._status=0,w._result=R)}if(w._status===1)return w._result.default;throw w._result}var Et=typeof reportError=="function"?reportError:function(w){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var R=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof w=="object"&&w!==null&&typeof w.message=="string"?String(w.message):String(w),error:w});if(!window.dispatchEvent(R))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",w);return}console.error(w)},St={map:Q,forEach:function(w,R,G){Q(w,function(){R.apply(this,arguments)},G)},count:function(w){var R=0;return Q(w,function(){R++}),R},toArray:function(w){return Q(w,function(R){return R})||[]},only:function(w){if(!P(w))throw Error("React.Children.only expected to receive a single React element child.");return w}};return ot.Activity=k,ot.Children=St,ot.Component=q,ot.Fragment=h,ot.Profiler=c,ot.PureComponent=Y,ot.StrictMode=o,ot.Suspense=g,ot.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=j,ot.__COMPILER_RUNTIME={__proto__:null,c:function(w){return j.H.useMemoCache(w)}},ot.cache=function(w){return function(){return w.apply(null,arguments)}},ot.cacheSignal=function(){return null},ot.cloneElement=function(w,R,G){if(w==null)throw Error("The argument must be a React element, but you passed "+w+".");var F=Z({},w.props),ut=w.key;if(R!=null)for(ft in R.key!==void 0&&(ut=""+R.key),R)!B.call(R,ft)||ft==="key"||ft==="__self"||ft==="__source"||ft==="ref"&&R.ref===void 0||(F[ft]=R[ft]);var ft=arguments.length-2;if(ft===1)F.children=G;else if(1<ft){for(var dt=Array(ft),Rt=0;Rt<ft;Rt++)dt[Rt]=arguments[Rt+2];F.children=dt}return X(w.type,ut,F)},ot.createContext=function(w){return w={$$typeof:b,_currentValue:w,_currentValue2:w,_threadCount:0,Provider:null,Consumer:null},w.Provider=w,w.Consumer={$$typeof:d,_context:w},w},ot.createElement=function(w,R,G){var F,ut={},ft=null;if(R!=null)for(F in R.key!==void 0&&(ft=""+R.key),R)B.call(R,F)&&F!=="key"&&F!=="__self"&&F!=="__source"&&(ut[F]=R[F]);var dt=arguments.length-2;if(dt===1)ut.children=G;else if(1<dt){for(var Rt=Array(dt),Ct=0;Ct<dt;Ct++)Rt[Ct]=arguments[Ct+2];ut.children=Rt}if(w&&w.defaultProps)for(F in dt=w.defaultProps,dt)ut[F]===void 0&&(ut[F]=dt[F]);return X(w,ft,ut)},ot.createRef=function(){return{current:null}},ot.forwardRef=function(w){return{$$typeof:T,render:w}},ot.isValidElement=P,ot.lazy=function(w){return{$$typeof:z,_payload:{_status:-1,_result:w},_init:at}},ot.memo=function(w,R){return{$$typeof:y,type:w,compare:R===void 0?null:R}},ot.startTransition=function(w){var R=j.T,G={};j.T=G;try{var F=w(),ut=j.S;ut!==null&&ut(G,F),typeof F=="object"&&F!==null&&typeof F.then=="function"&&F.then(V,Et)}catch(ft){Et(ft)}finally{R!==null&&G.types!==null&&(R.types=G.types),j.T=R}},ot.unstable_useCacheRefresh=function(){return j.H.useCacheRefresh()},ot.use=function(w){return j.H.use(w)},ot.useActionState=function(w,R,G){return j.H.useActionState(w,R,G)},ot.useCallback=function(w,R){return j.H.useCallback(w,R)},ot.useContext=function(w){return j.H.useContext(w)},ot.useDebugValue=function(){},ot.useDeferredValue=function(w,R){return j.H.useDeferredValue(w,R)},ot.useEffect=function(w,R){return j.H.useEffect(w,R)},ot.useEffectEvent=function(w){return j.H.useEffectEvent(w)},ot.useId=function(){return j.H.useId()},ot.useImperativeHandle=function(w,R,G){return j.H.useImperativeHandle(w,R,G)},ot.useInsertionEffect=function(w,R){return j.H.useInsertionEffect(w,R)},ot.useLayoutEffect=function(w,R){return j.H.useLayoutEffect(w,R)},ot.useMemo=function(w,R){return j.H.useMemo(w,R)},ot.useOptimistic=function(w,R){return j.H.useOptimistic(w,R)},ot.useReducer=function(w,R,G){return j.H.useReducer(w,R,G)},ot.useRef=function(w){return j.H.useRef(w)},ot.useState=function(w){return j.H.useState(w)},ot.useSyncExternalStore=function(w,R,G){return j.H.useSyncExternalStore(w,R,G)},ot.useTransition=function(){return j.H.useTransition()},ot.version="19.2.6",ot}var fh;function es(){return fh||(fh=1,xr.exports=G0()),xr.exports}var yt=es(),Ar={exports:{}},Rl={},Cr={exports:{}},Nr={};/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const $0=yt.forwardRef(({color:r="currentColor",size:f=24,strokeWidth:h=2,absoluteStrokeWidth:o,className:c="",children:d,iconNode:b,...T},g)=>yt.createElement("svg",{ref:g,...W0,width:f,height:f,stroke:r,strokeWidth:o?Number(h)*24/Number(f):h,className:lg("lucide",c),...T},[...b.map(([y,z])=>yt.createElement(y,z)),...Array.isArray(d)?d:[d]]));/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ns=$t("X",[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]]);function nu({group:r,size:f="md",dim:h}){const o=f==="sm"?"px-2 py-0.5 text-xs":"px-3 py-1 text-sm";return p.jsx("span",{className:`inline-flex items-center rounded-full font-semibold ${r.bgClass} ${r.textClass} ${o} ${h?"opacity-40":""}`,children:r.label})}const Ua=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],bh=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"];function rg(r){if(r.length===0)return"";const f=[...r].sort((z,k)=>z.date.localeCompare(k.date)),h=f[0].date,o=f[f.length-1].date,[c,d,b]=h.split("-").map(Number),[T,g,y]=o.split("-").map(Number);return h===o?`${Ua[d-1]} ${b}, ${c}`:c===T&&d===g?`${Ua[d-1]} ${b}–${y}, ${c}`:c===T?`${Ua[d-1]} ${b} – ${Ua[g-1]} ${y}, ${c}`:`${Ua[d-1]} ${b}, ${c} – ${Ua[g-1]} ${y}, ${T}`}function cp(r){if(r.length===0)return"";const f=[...r].sort((U,L)=>U.date.localeCompare(L.date)),h=f[0].date,o=f[f.length-1].date,[c,d,b]=h.split("-").map(Number),[T,g,y]=o.split("-").map(Number),z=bh[new Date(c,d-1,b).getDay()],k=rg(r);if(h===o)return`${k} (${z})`;const O=bh[new Date(T,g-1,y).getDay()];return`${k} (${z}–${O})`}function wh(r){return r.subtitle??rg(r.days)}function en(r){const[f,h]=r.split(":").map(Number);return f*60+h}const fp=30;function dp(r,f){let h=-1;for(let T=0;T<r.length&&en(r[T])<=f;T++)h=T;if(h===-1)return{index:-1,progress:0};const o=en(r[h]),c=r[h+1]?en(r[h+1]):null,d=c!==null?c:o+fp;if(f>=d)return{index:-1,progress:0};const b=d===o?0:(f-o)/(d-o);return{index:h,progress:Math.max(0,Math.min(1,b))}}function sg(r){const[f,h]=r.split(":").map(Number);return`${f%12||12}:${h.toString().padStart(2,"0")}`}function cg(r){const[f]=r.split(":").map(Number);return f>=12?"PM":"AM"}function as(){const r=new Date;return r.getHours()*60+r.getMinutes()}function Ol(){const r=new Date,f=r.getFullYear(),h=String(r.getMonth()+1).padStart(2,"0"),o=String(r.getDate()).padStart(2,"0");return`${f}-${h}-${o}`}function hp(){const r=new Date,f=r.getHours(),h=r.getMinutes(),o=f%12||12,c=f>=12?"PM":"AM";return`${o}:${h.toString().padStart(2,"0")} ${c}`}function gp(r){if(r<=0)return"";if(r<60)return`${r} min`;const f=Math.floor(r/60),h=r%60;return h===0?`${f}h`:`${f}h ${h}m`}function mp(r){const f=new Date(r);if(isNaN(f.getTime()))return r;const h=f.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"}),o=f.toLocaleTimeString(void 0,{hour:"numeric",minute:"2-digit"});return`${h}, ${o}`}function Sh(r,f){return r.flatMap(h=>{const o=f.find(c=>c.id===h);return o?[o]:[]})}function pp({activity:r,runGroups:f,past:h}){const o=Sh(r.onTrack,f),c=Sh(r.inClass??[],f);return p.jsx("div",{className:`rounded-xl border border-gray-200 bg-white p-4 shadow-sm transition-opacity ${h?"opacity-60":""}`,children:p.jsxs("div",{className:"flex gap-4",children:[p.jsxs("div",{className:"flex w-20 shrink-0 items-baseline gap-0.5 font-mono text-lg font-semibold text-gray-900",children:[sg(r.time),p.jsx("span",{className:"font-sans text-[10px] font-normal text-gray-400",children:cg(r.time)})]}),p.jsxs("div",{className:"flex flex-1 flex-col gap-3",children:[o.length>0&&p.jsxs("div",{className:"flex items-center gap-3",children:[p.jsx("span",{className:"w-16 shrink-0 text-xs text-gray-900",children:"On track"}),p.jsx("div",{className:"flex flex-wrap gap-1.5",children:o.map(d=>p.jsx(nu,{group:d},d.id))})]}),c.length>0&&p.jsxs(p.Fragment,{children:[o.length>0&&p.jsx("div",{className:"border-t border-gray-100"}),p.jsxs("div",{className:"flex items-center gap-3",children:[p.jsx("span",{className:"w-16 shrink-0 text-xs text-gray-900",children:"In class"}),p.jsx("div",{className:"flex flex-wrap gap-1.5",children:c.map(d=>p.jsx(nu,{group:d},d.id))})]})]}),r.note&&p.jsx("p",{className:"text-xs italic text-gray-500",children:r.note})]})]})})}function yp({activity:r,past:f}){const h=r.type==="lunch"||r.type==="special";return p.jsx("div",{className:`rounded-xl p-4 shadow-sm transition-opacity ${h?"border-2 border-gray-900 bg-white my-2":"border border-gray-200 bg-white"} ${f?"opacity-60":""}`,children:p.jsxs("div",{className:"flex items-center gap-4",children:[p.jsxs("div",{className:"flex w-20 shrink-0 items-baseline gap-0.5 font-mono text-lg font-semibold text-gray-900",children:[sg(r.time),p.jsx("span",{className:"font-sans text-[10px] font-normal text-gray-400",children:cg(r.time)})]}),h&&p.jsx("div",{className:"flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-gray-900 text-white",children:r.type==="lunch"?p.jsx(sp,{size:16}):p.jsx(ip,{size:16})}),p.jsxs("div",{children:[p.jsx("p",{className:"text-sm font-medium text-gray-900",children:r.label}),r.subtitle&&p.jsx("p",{className:"mt-0.5 text-xs text-gray-500",children:r.subtitle})]})]})})}const Pr=yt.forwardRef(({activities:r},f)=>{const[,h]=yt.useState(0);yt.useEffect(()=>{const g=setInterval(()=>h(y=>y+1),3e4);return()=>clearInterval(g)},[]);const o=as(),d=r.filter(g=>"time"in g).find(g=>en(g.time)>o),b=d?en(d.time)-o:null,T=b!==null?b<=5?"text-red-500":b<=10?"text-orange-500":"text-gray-400":"text-gray-400";return p.jsxs("div",{ref:f,"data-time-indicator":!0,className:"relative my-6",children:[p.jsxs("div",{className:"flex items-center -mr-3 sm:-mr-4",children:[p.jsx("div",{className:"h-2.5 w-2.5 shrink-0 rounded-full bg-blue-500"}),p.jsx("div",{className:"h-0.5 flex-1 bg-blue-500"})]}),p.jsx("span",{className:"absolute left-4 -top-5 font-mono text-xs font-semibold text-blue-500",children:hp()}),b!==null&&p.jsxs("span",{className:`absolute right-0 -top-5 text-xs ${T}`,children:["Next activity starts in ",p.jsx("span",{className:"font-semibold",children:gp(b)})]})]})});Pr.displayName="TimeIndicator";function Th({collapsed:r,children:f}){return p.jsx("div",{"data-collapsed":r,"aria-hidden":r,className:"grid transition-[grid-template-rows,opacity,margin-bottom] duration-300 ease-in-out",style:{gridTemplateRows:r?"0fr":"1fr",opacity:r?0:1,marginBottom:r?0:"0.5rem"},children:p.jsx("div",{className:"overflow-hidden",children:f})})}function vp({activities:r,runGroups:f,isToday:h,selectedGroups:o,hidePast:c}){const d=yt.useRef(null),[,b]=yt.useState(0);yt.useEffect(()=>{if(!h)return;const H=setInterval(()=>b(Y=>Y+1),6e4);return()=>clearInterval(H)},[h]),yt.useEffect(()=>{if(!h)return;const H=setTimeout(()=>{var Y;(Y=d.current)==null||Y.scrollIntoView({behavior:"smooth",block:"center"})},150);return()=>clearTimeout(H)},[h]);const T=as(),g=r.flatMap(H=>{if(H.type!=="session")return[H];if(o.length===0)return[H];const Y=H.onTrack.filter(ct=>o.includes(ct)),K=(H.inClass??[]).filter(ct=>o.includes(ct));return Y.length===0&&K.length===0?[]:[{...H,onTrack:Y,inClass:K}]}),y=g.map(H=>H.type!=="break"&&c&&h&&en(H.time)<T);g.forEach((H,Y)=>{if(H.type!=="break")return;const K=g.slice(0,Y).some((ct,V)=>ct.type!=="break"&&!y[V]);y[Y]=!K});const z=[],k=[];g.forEach((H,Y)=>{H.type!=="break"&&(z.push(Y),k.push(H.time))});const{index:O}=h?dp(k,T):{index:-1},U=O===-1?-1:z[O],L=h?g.findIndex(H=>H.type!=="break"&&en(H.time)>T):-1,Z=h&&L===-1&&g.length>0,J=g.length>0&&y.every(Boolean);let q;return p.jsxs("div",{className:"flex flex-col pb-10",children:[g.length>0&&p.jsx(Th,{collapsed:!J,children:p.jsxs("div",{className:"flex flex-col items-center gap-1 rounded-2xl border border-gray-200 bg-white px-6 py-10 text-center shadow-sm",children:[p.jsx("p",{className:"text-sm font-medium text-gray-500",children:"That's a wrap for today"}),p.jsx("p",{className:"text-xs text-gray-400",children:"Every activity on today's schedule has already happened."})]})}),g.map((H,Y)=>{const K=Y===U,ct=h&&H.type!=="break"&&!K&&en(H.time)<T;let V=null;!y[Y]&&H.type==="session"&&H.sessionNumber!==void 0&&H.sessionNumber!==q&&(q=H.sessionNumber,V=p.jsxs("div",{className:"mt-5 mb-1 text-xs font-bold uppercase tracking-widest text-gray-400",children:["Session ",H.sessionNumber]}));const j=H.type==="break"?p.jsxs("div",{className:"flex items-center gap-2 py-1",children:[p.jsx("div",{className:"h-px flex-1 bg-gray-200"}),p.jsx("span",{className:"text-xs text-gray-400 italic",children:H.label}),p.jsx("div",{className:"h-px flex-1 bg-gray-200"})]}):H.type==="session"?p.jsx(pp,{activity:H,runGroups:f,past:ct}):p.jsx(yp,{activity:H,past:ct});return p.jsxs(Th,{collapsed:y[Y],children:[Y===L&&p.jsx(Pr,{ref:d,activities:g}),V,j]},Y)}),Z&&p.jsx(Pr,{ref:d,activities:g})]})}function bp({groups:r,selected:f,onChange:h}){const[o,c]=yt.useState(!1),d=g=>h(f.includes(g)?f.filter(y=>y!==g):[...f,g]),b=f.length===0||f.length===r.length,T=r.filter(g=>f.includes(g.id));return p.jsxs("div",{className:"relative",children:[p.jsxs("button",{onClick:()=>c(g=>!g),className:"flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-3 py-1.5 text-sm shadow-sm transition-colors hover:border-gray-400",children:[b?p.jsx("span",{className:"text-gray-700",children:"All run groups"}):p.jsx("div",{className:"flex items-center gap-1",children:T.map(g=>p.jsx(nu,{group:g,size:"sm"},g.id))}),p.jsx(ug,{size:14,className:"text-gray-400"})]}),o&&p.jsxs(p.Fragment,{children:[p.jsx("div",{className:"fixed inset-0 z-10",onClick:()=>c(!1)}),p.jsxs("div",{className:"absolute left-0 top-full z-20 mt-1 min-w-[180px] rounded-xl border border-gray-200 bg-white p-1 shadow-xl",children:[r.map(g=>p.jsxs("button",{onClick:()=>d(g.id),className:"flex w-full items-center justify-between rounded-lg px-3 py-2 hover:bg-gray-50",children:[p.jsx(nu,{group:g,size:"md"}),f.includes(g.id)&&p.jsx(au,{size:14,className:"text-blue-500"})]},g.id)),p.jsx("div",{className:"mt-1 border-t border-gray-100 pt-1",children:p.jsx("button",{onClick:()=>{h([]),c(!1)},className:"w-full rounded-lg px-3 py-2 text-left text-sm text-gray-400 hover:bg-gray-50",children:b?"All selected":"Clear filter"})})]})]})]})}function Eh(r){const f=Ol();return r.days.some(h=>h.date===f)}function xh(){return p.jsxs("span",{className:"ml-2 inline-flex shrink-0 items-center gap-1 rounded-full bg-green-100 px-1.5 py-px text-[9px] font-semibold uppercase tracking-wide text-green-700",children:[p.jsx("span",{className:"h-1 w-1 rounded-full bg-green-700 animate-pulse"}),"Live"]})}function wp({events:r,active:f,onChange:h,onOpenDetails:o}){const[c,d]=yt.useState(!1);return p.jsxs("div",{className:"relative min-w-0 pl-1",children:[p.jsxs("button",{onClick:()=>d(b=>!b),className:"flex items-center gap-1 text-left group min-w-0",children:[p.jsx("h1",{className:"text-xl font-bold text-gray-900 leading-tight",children:f.name}),Eh(f)&&p.jsx(xh,{}),p.jsx(ug,{size:16,className:"shrink-0 text-gray-400 group-hover:text-gray-600 transition-colors"})]}),p.jsxs("div",{className:"flex items-center gap-0.5",children:[p.jsx("p",{className:"text-sm text-gray-500",children:wh(f)}),p.jsx("button",{onClick:o,"aria-label":"Event details",className:"inline-grid h-[22px] w-[22px] shrink-0 place-items-center rounded-full text-gray-400 transition-colors hover:bg-gray-100 hover:text-gray-900",children:p.jsx(np,{size:14})})]}),c&&p.jsxs(p.Fragment,{children:[p.jsx("div",{className:"fixed inset-0 z-10",onClick:()=>d(!1)}),p.jsx("div",{className:"absolute left-0 top-full z-20 mt-2 min-w-[200px] rounded-xl border border-gray-200 bg-white p-1 shadow-xl",children:r.map(b=>p.jsxs("button",{onClick:()=>{h(b),d(!1)},className:`flex w-full items-center justify-between rounded-lg px-4 py-2.5 text-left ${b.id===f.id?"bg-blue-50":"hover:bg-gray-50"}`,children:[p.jsxs("div",{children:[p.jsxs("div",{className:"flex items-center gap-1.5",children:[p.jsx("span",{className:"text-sm font-semibold text-gray-900",children:b.name}),Eh(b)&&p.jsx(xh,{})]}),p.jsx("div",{className:"text-xs text-gray-400",children:wh(b)})]}),b.id===f.id&&p.jsx(au,{size:14,className:"text-blue-500 ml-3 shrink-0"})]},b.id))})]})]})}function Sp({checked:r,onChange:f,label:h}){return p.jsxs("label",{style:{display:"flex",alignItems:"center",gap:"8px",cursor:"pointer",userSelect:"none"},children:[h&&p.jsx("span",{style:{fontSize:"14px",color:"#4b5563"},children:h}),p.jsx("button",{type:"button",role:"switch","aria-checked":r,onClick:f,style:{position:"relative",display:"inline-block",width:"44px",height:"24px",borderRadius:"12px",backgroundColor:r?"#000000":"#d1d5db",border:"none",cursor:"pointer",padding:0,flexShrink:0,transition:"background-color 0.2s ease",WebkitTapHighlightColor:"transparent"},children:p.jsx("span",{style:{position:"absolute",top:"2px",left:r?"22px":"2px",width:"20px",height:"20px",borderRadius:"50%",backgroundColor:"white",boxShadow:"0 1px 4px rgba(0,0,0,0.25)",transition:"left 0.2s ease",display:"block"}})})]})}const Jn=72,Tp=110;function Ep({children:r,disabled:f}){const[h,o]=yt.useState(0),[c,d]=yt.useState("idle"),b=yt.useRef(null),T=yt.useRef(0);yt.useEffect(()=>{if(f)return;const k=L=>{window.scrollY===0&&(b.current=L.touches[0].clientY)},O=L=>{if(b.current===null)return;const Z=L.touches[0].clientY-b.current;if(Z<=0){b.current=null;return}L.preventDefault();const J=Z<Jn?Z:Jn+(Z-Jn)*.25;T.current=Math.min(J,Tp),o(T.current),d("pulling")},U=()=>{b.current!==null&&(b.current=null,T.current>=Jn?(d("refreshing"),o(Jn*.75),setTimeout(()=>window.location.reload(),600)):(d("releasing"),o(0),T.current=0,setTimeout(()=>d("idle"),250)))};return document.addEventListener("touchstart",k,{passive:!0}),document.addEventListener("touchmove",O,{passive:!1}),document.addEventListener("touchend",U),document.addEventListener("touchcancel",U),()=>{document.removeEventListener("touchstart",k),document.removeEventListener("touchmove",O),document.removeEventListener("touchend",U),document.removeEventListener("touchcancel",U)}},[f]);const g=c==="releasing"||c==="refreshing",y=Math.min(h/Jn,1),z=h>=Jn;return p.jsxs(p.Fragment,{children:[p.jsx("div",{className:"pointer-events-none fixed inset-x-0 z-50 flex justify-center",style:{top:-44,transform:`translateY(${h}px)`,transition:g?"transform 0.25s ease":"none"},children:p.jsx("div",{className:`flex h-8 w-8 items-center justify-center rounded-full bg-white shadow-md ${z?"text-blue-500":"text-gray-400"}`,children:p.jsx(up,{size:16,className:c==="refreshing"?"animate-spin":"",style:c!=="refreshing"?{transform:`rotate(${y*270}deg)`}:void 0})})}),p.jsx("div",{style:{transform:`translateY(${h}px)`,transition:g?"transform 0.25s ease":"none"},children:r})]})}function xp({groups:r}){const f=r.filter(h=>h.description);return f.length===0?null:p.jsxs("div",{className:"mt-2 rounded-2xl border border-gray-200 bg-white p-4 shadow-sm",children:[p.jsx("div",{className:"mb-2 text-xs font-bold uppercase tracking-widest text-gray-400",children:"Legend"}),p.jsx("ul",{className:"flex flex-col gap-1.5",children:f.map(h=>p.jsxs("li",{className:"flex items-center gap-2 text-sm text-gray-700",children:[p.jsx("span",{className:`h-3 w-3 shrink-0 rounded-full ${h.bgClass}`,"aria-hidden":"true"}),p.jsx("span",{className:"font-medium text-gray-900",children:h.label}),p.jsx("span",{className:"text-gray-400",children:"·"}),p.jsx("span",{children:h.description})]},h.id))})]})}const Ah=`// HPDE track-day schedule — iOS Home Screen widget for Scriptable.
...
`,is="/hpde/pr-preview/pr-186/assets/msrc-1-7-D9G0r_nf.jpg",ly={...Ba("2026-09-11_msrc-1-7",ay),mapImage:is},iy=`# SCCA at MSRC 1.7 CW
...
`,cy="/hpde/pr-preview/pr-186/assets/msrc-3-1-BsOP6CK2.png",fy={...Ba("2025-11-07_msrc-3-1",sy),mapImage:cy},dy=`# TDE at ECR 2.7
...
`,hy="/hpde/pr-preview/pr-186/assets/ecr-BW_3Ndfh.png",gy={...Ba("2026-05-30_ecr-2-7",dy),mapImage:hy},my=`# Test Event
