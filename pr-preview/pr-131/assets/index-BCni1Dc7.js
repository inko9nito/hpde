 ...
 */var uh;function Ug(){if(uh)return za;uh=1;var o=Symbol.for("react.transitional.element"),f=Symbol.for("react.fragment");function h(c,s,d){var v=null;if(d!==void 0&&(v=""+d),s.key!==void 0&&(v=""+s.key),"key"in s){d={};for(var w in s)w!=="key"&&(d[w]=s[w])}else d=s;return s=d.ref,{$$typeof:o,type:c,key:v,ref:s!==void 0?s:null,props:d}}return za.Fragment=f,za.jsx=h,za.jsxs=h,za}var ch;function Hg(){return ch||(ch=1,To.exports=Ug()),To.exports}var b=Hg(),xo={exports:{}},ct={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var dh;function kg(){if(dh)return $t;dh=1;var o=er();function f(m){var S="https://react.dev/errors/"+m;if(1<arguments.length){S+="?args[]="+encodeURIComponent(arguments[1]);for(var B=2;B<arguments.length;B++)S+="&args[]="+encodeURIComponent(arguments[B])}return"Minified React error #"+m+"; visit "+S+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function h(){}var c={d:{f:h,r:function(){throw Error(f(522))},D:h,C:h,L:h,m:h,X:h,S:h,M:h},p:0,findDOMNode:null},s=Symbol.for("react.portal");function d(m,S,B){var D=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:s,key:D==null?null:""+D,children:m,containerInfo:S,implementation:B}}var v=o.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function w(m,S){if(m==="font")return"";if(typeof S=="string")return S==="use-credentials"?S:""}return $t.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=c,$t.createPortal=function(m,S){var B=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!S||S.nodeType!==1&&S.nodeType!==9&&S.nodeType!==11)throw Error(f(299));return d(m,S,null,B)},$t.flushSync=function(m){var S=v.T,B=c.p;try{if(v.T=null,c.p=2,m)return m()}finally{v.T=S,c.p=B,c.d.f()}},$t.preconnect=function(m,S){typeof m=="string"&&(S?(S=S.crossOrigin,S=typeof S=="string"?S==="use-credentials"?S:"":void 0):S=null,c.d.C(m,S))},$t.prefetchDNS=function(m){typeof m=="string"&&c.d.D(m)},$t.preinit=function(m,S){if(typeof m=="string"&&S&&typeof S.as=="string"){var B=S.as,D=w(B,S.crossOrigin),U=typeof S.integrity=="string"?S.integrity:void 0,H=typeof S.fetchPriority=="string"?S.fetchPriority:void 0;B==="style"?c.d.S(m,typeof S.precedence=="string"?S.precedence:void 0,{crossOrigin:D,integrity:U,fetchPriority:H}):B==="script"&&c.d.X(m,{crossOrigin:D,integrity:U,fetchPriority:H,nonce:typeof S.nonce=="string"?S.nonce:void 0})}},$t.preinitModule=function(m,S){if(typeof m=="string")if(typeof S=="object"&&S!==null){if(S.as==null||S.as==="script"){var B=w(S.as,S.crossOrigin);c.d.M(m,{crossOrigin:B,integrity:typeof S.integrity=="string"?S.integrity:void 0,nonce:typeof S.nonce=="string"?S.nonce:void 0})}}else S==null&&c.d.M(m)},$t.preload=function(m,S){if(typeof m=="string"&&typeof S=="object"&&S!==null&&typeof S.as=="string"){var B=S.as,D=w(B,S.crossOrigin);c.d.L(m,B,{crossOrigin:D,integrity:typeof S.integrity=="string"?S.integrity:void 0,nonce:typeof S.nonce=="string"?S.nonce:void 0,type:typeof S.type=="string"?S.type:void 0,fetchPriority:typeof S.fetchPriority=="string"?S.fetchPriority:void 0,referrerPolicy:typeof S.referrerPolicy=="string"?S.referrerPolicy:void 0,imageSrcSet:typeof S.imageSrcSet=="string"?S.imageSrcSet:void 0,imageSizes:typeof S.imageSizes=="string"?S.imageSizes:void 0,media:typeof S.media=="string"?S.media:void 0})}},$t.preloadModule=function(m,S){if(typeof m=="string")if(S){var B=w(S.as,S.crossOrigin);c.d.m(m,{as:typeof S.as=="string"&&S.as!=="script"?S.as:void 0,crossOrigin:B,integrity:typeof S.integrity=="string"?S.integrity:void 0})}else c.d.m(m)},$t.requestFormReset=function(m){c.d.r(m)},$t.unstable_batchedUpdates=function(m,S){return m(S)},$t.useFormState=function(m,S,B){return v.H.useFormState(m,S,B)},$t.useFormStatus=function(){return v.H.useHostTransitionStatus()},$t.version="19.2.6",$t}var hh;function Gg(){if(hh)return _o.exports;hh=1;function o(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(o)}catch(f){console.error(f)}}return o(),_o.exports=kg(),_o.exports}/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Kg=pt.forwardRef(({color:o="currentColor",size:f=24,strokeWidth:h=2,absoluteStrokeWidth:c,className:s="",children:d,iconNode:v,...w},m)=>pt.createElement("svg",{ref:m,...Zg,width:f,height:f,stroke:o,strokeWidth:c?Number(h)*24/Number(f):h,className:t0("lucide",s),...w},[...v.map(([S,B])=>pt.createElement(S,B)),...Array.isArray(d)?d:[d]]));/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ce=(o,f)=>{const h=pt.forwardRef(({className:c,...s},d)=>pt.createElement(Kg,{ref:d,iconNode:f,className:t0(`lucide-${Xg(o)}`,c),...s}));return h.displayName=`${o}`,h};/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const l0=Ce("X",[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]]);function nu({group:o,size:f="md",dim:h}){const c=f==="sm"?"px-2 py-0.5 text-xs":"px-3 py-1 text-sm";return b.jsx("span",{className:`inline-flex items-center rounded-full font-semibold ${o.bgClass} ${o.textClass} ${c} ${h?"opacity-40":""}`,children:o.label})}function en(o){const[f,h]=o.split(":").map(Number);return f*60+h}const e1=30;function n1(o,f){let h=-1;for(let w=0;w<o.length&&en(o[w])<=f;w++)h=w;if(h===-1)return{index:-1,progress:0};const c=en(o[h]),s=o[h+1]?en(o[h+1]):null,d=s!==null?s:c+e1;if(f>=d)return{index:-1,progress:0};const v=d===c?0:(f-c)/(d-c);return{index:h,progress:Math.max(0,Math.min(1,v))}}function a0(o){const[f,h]=o.split(":").map(Number);return`${f%12||12}:${h.toString().padStart(2,"0")}`}function i0(o){const[f]=o.split(":").map(Number);return f>=12?"PM":"AM"}function nr(){const o=new Date;return o.getHours()*60+o.getMinutes()}function Ba(){const o=new Date,f=o.getFullYear(),h=String(o.getMonth()+1).padStart(2,"0"),c=String(o.getDate()).padStart(2,"0");return`${f}-${h}-${c}`}function l1(){const o=new Date,f=o.getHours(),h=o.getMinutes(),c=f%12||12,s=f>=12?"PM":"AM";return`${c}:${h.toString().padStart(2,"0")} ${s}`}function a1(o){if(o<=0)return"";if(o<60)return`${o} min`;const f=Math.floor(o/60),h=o%60;return h===0?`${f}h`:`${f}h ${h}m`}function i1(o){const f=new Date(o);if(isNaN(f.getTime()))return o;const h=f.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"}),c=f.toLocaleTimeString(void 0,{hour:"numeric",minute:"2-digit"});return`${h}, ${c}`}function ph(o,f){return o.flatMap(h=>{const c=f.find(s=>s.id===h);return c?[c]:[]})}function u1({event:o,runGroups:f,past:h}){const c=ph(o.onTrack,f),s=ph(o.inClass??[],f);return b.jsx("div",{className:`rounded-xl border border-gray-200 bg-white p-4 shadow-sm transition-opacity ${h?"opacity-60":""}`,children:b.jsxs("div",{className:"flex gap-4",children:[b.jsxs("div",{className:"flex w-20 shrink-0 items-baseline gap-0.5 font-mono text-lg font-semibold text-gray-900",children:[a0(o.time),b.jsx("span",{className:"font-sans text-[10px] font-normal text-gray-400",children:i0(o.time)})]}),b.jsxs("div",{className:"flex flex-1 flex-col gap-3",children:[c.length>0&&b.jsxs("div",{className:"flex items-center gap-3",children:[b.jsx("span",{className:"w-16 shrink-0 text-xs text-gray-900",children:"On track"}),b.jsx("div",{className:"flex flex-wrap gap-1.5",children:c.map(d=>b.jsx(nu,{group:d},d.id))})]}),s.length>0&&b.jsxs(b.Fragment,{children:[c.length>0&&b.jsx("div",{className:"border-t border-gray-100"}),b.jsxs("div",{className:"flex items-center gap-3",children:[b.jsx("span",{className:"w-16 shrink-0 text-xs text-gray-900",children:"In class"}),b.jsx("div",{className:"flex flex-wrap gap-1.5",children:s.map(d=>b.jsx(nu,{group:d},d.id))})]})]}),o.note&&b.jsx("p",{className:"text-xs italic text-gray-500",children:o.note})]})]})})}function c1({event:o,past:f}){const h=o.type==="lunch"||o.type==="special";return b.jsx("div",{className:`rounded-xl p-4 shadow-sm transition-opacity ${h?"border-2 border-gray-900 bg-white my-2":"border border-gray-200 bg-white"} ${f?"opacity-60":""}`,children:b.jsxs("div",{className:"flex items-center gap-4",children:[b.jsxs("div",{className:"flex w-20 shrink-0 items-baseline gap-0.5 font-mono text-lg font-semibold text-gray-900",children:[a0(o.time),b.jsx("span",{className:"font-sans text-[10px] font-normal text-gray-400",children:i0(o.time)})]}),h&&b.jsx("div",{className:"flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-gray-900 text-white",children:o.type==="lunch"?b.jsx(t1,{size:16}):b.jsx($g,{size:16})}),b.jsxs("div",{children:[b.jsx("p",{className:"text-sm font-medium text-gray-900",children:o.label}),o.subtitle&&b.jsx("p",{className:"mt-0.5 text-xs text-gray-500",children:o.subtitle})]})]})})}const Po=pt.forwardRef(({events:o},f)=>{const[,h]=pt.useState(0);pt.useEffect(()=>{const m=setInterval(()=>h(S=>S+1),3e4);return()=>clearInterval(m)},[]);const c=nr(),d=o.filter(m=>"time"in m).find(m=>en(m.time)>c),v=d?en(d.time)-c:null,w=v!==null?v<=5?"text-red-500":v<=10?"text-orange-500":"text-gray-400":"text-gray-400";return b.jsxs("div",{ref:f,"data-time-indicator":!0,className:"relative my-6",children:[b.jsxs("div",{className:"flex items-center -mr-3 sm:-mr-4",children:[b.jsx("div",{className:"h-2.5 w-2.5 shrink-0 rounded-full bg-blue-500"}),b.jsx("div",{className:"h-0.5 flex-1 bg-blue-500"})]}),b.jsx("span",{className:"absolute left-4 -top-5 font-mono text-xs font-semibold text-blue-500",children:l1()}),v!==null&&b.jsxs("span",{className:`absolute right-0 -top-5 text-xs ${w}`,children:["Next event starts in ",b.jsx("span",{className:"font-semibold",children:a1(v)})]})]})});Po.displayName="TimeIndicator";function vh({collapsed:o,children:f}){return b.jsx("div",{"data-collapsed":o,"aria-hidden":o,className:"grid transition-[grid-template-rows,opacity,margin-bottom] duration-300 ease-in-out",style:{gridTemplateRows:o?"0fr":"1fr",opacity:o?0:1,marginBottom:o?0:"0.5rem"},children:b.jsx("div",{className:"overflow-hidden",children:f})})}function o1({events:o,runGroups:f,isToday:h,selectedGroups:c,hidePast:s}){const d=pt.useRef(null),[,v]=pt.useState(0);pt.useEffect(()=>{if(!h)return;const q=setInterval(()=>v(k=>k+1),6e4);return()=>clearInterval(q)},[h]),pt.useEffect(()=>{if(!h)return;const q=setTimeout(()=>{var k;(k=d.current)==null||k.scrollIntoView({behavior:"smooth",block:"center"})},150);return()=>clearTimeout(q)},[h]);const w=nr(),m=o.flatMap(q=>{if(q.type!=="session")return[q];if(c.length===0)return[q];const k=q.onTrack.filter(st=>c.includes(st)),K=(q.inClass??[]).filter(st=>c.includes(st));return k.length===0&&K.length===0?[]:[{...q,onTrack:k,inClass:K}]}),S=m.map(q=>q.type!=="break"&&s&&h&&en(q.time)<w);m.forEach((q,k)=>{if(q.type!=="break")return;const K=m.slice(0,k).some((st,Q)=>st.type!=="break"&&!S[Q]);S[k]=!K});const B=[],D=[];m.forEach((q,k)=>{q.type!=="break"&&(B.push(k),D.push(q.time))});const{index:U}=h?n1(D,w):{index:-1},H=U===-1?-1:B[U],O=h?m.findIndex(q=>q.type!=="break"&&en(q.time)>w):-1,G=h&&O===-1&&m.length>0,it=m.length>0&&S.every(Boolean);let Z;return b.jsxs("div",{className:"flex flex-col pb-10",children:[m.length>0&&b.jsx(vh,{collapsed:!it,children:b.jsxs("div",{className:"flex flex-col items-center gap-1 rounded-2xl border border-gray-200 bg-white px-6 py-10 text-center shadow-sm",children:[b.jsx("p",{className:"text-sm font-medium text-gray-500",children:"That's a wrap for today"}),b.jsx("p",{className:"text-xs text-gray-400",children:"Every event on today's schedule has already happened."})]})}),m.map((q,k)=>{const K=k===H,st=h&&q.type!=="break"&&!K&&en(q.time)<w;let Q=null;!S[k]&&q.type==="session"&&q.sessionNumber!==void 0&&q.sessionNumber!==Z&&(Z=q.sessionNumber,Q=b.jsxs("div",{className:"mt-5 mb-1 text-xs font-bold uppercase tracking-widest text-gray-400",children:["Session ",q.sessionNumber]}));const L=q.type==="break"?b.jsxs("div",{className:"flex items-center gap-2 py-1",children:[b.jsx("div",{className:"h-px flex-1 bg-gray-200"}),b.jsx("span",{className:"text-xs text-gray-400 italic",children:q.label}),b.jsx("div",{className:"h-px flex-1 bg-gray-200"})]}):q.type==="session"?b.jsx(u1,{event:q,runGroups:f,past:st}):b.jsx(c1,{event:q,past:st});return b.jsxs(vh,{collapsed:S[k],children:[k===O&&b.jsx(Po,{ref:d,events:m}),Q,L]},k)}),G&&b.jsx(Po,{ref:d,events:m})]})}function r1({groups:o,selected:f,onChange:h}){const[c,s]=pt.useState(!1),d=m=>h(f.includes(m)?f.filter(S=>S!==m):[...f,m]),v=f.length===0||f.length===o.length,w=o.filter(m=>f.includes(m.id));return b.jsxs("div",{className:"relative",children:[b.jsxs("button",{onClick:()=>s(m=>!m),className:"flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-3 py-1.5 text-sm shadow-sm transition-colors hover:border-gray-400",children:[v?b.jsx("span",{className:"text-gray-700",children:"All run groups"}):b.jsx("div",{className:"flex items-center gap-1",children:w.map(m=>b.jsx(nu,{group:m,size:"sm"},m.id))}),b.jsx(e0,{size:14,className:"text-gray-400"})]}),c&&b.jsxs(b.Fragment,{children:[b.jsx("div",{className:"fixed inset-0 z-10",onClick:()=>s(!1)}),b.jsxs("div",{className:"absolute left-0 top-full z-20 mt-1 min-w-[180px] rounded-xl border border-gray-200 bg-white p-1 shadow-xl",children:[o.map(m=>b.jsxs("button",{onClick:()=>d(m.id),className:"flex w-full items-center justify-between rounded-lg px-3 py-2 hover:bg-gray-50",children:[b.jsx(nu,{group:m,size:"md"}),f.includes(m.id)&&b.jsx(lu,{size:14,className:"text-blue-500"})]},m.id)),b.jsx("div",{className:"mt-1 border-t border-gray-100 pt-1",children:b.jsx("button",{onClick:()=>{h([]),s(!1)},className:"w-full rounded-lg px-3 py-2 text-left text-sm text-gray-400 hover:bg-gray-50",children:v?"All selected":"Clear filter"})})]})]})]})}function bh(o){const f=Ba();return o.days.some(h=>h.date===f)}function Sh(){return b.jsxs("span",{className:"ml-2 inline-flex shrink-0 items-center gap-1 rounded-full bg-green-100 px-1.5 py-px text-[9px] font-semibold uppercase tracking-wide text-green-700",children:[b.jsx("span",{className:"h-1 w-1 rounded-full bg-green-700 animate-pulse"}),"Live"]})}function s1({events:o,active:f,onChange:h,onOpenDetails:c}){const[s,d]=pt.useState(!1);return b.jsxs("div",{className:"relative min-w-0 pl-1",children:[b.jsxs("button",{onClick:()=>d(v=>!v),className:"flex items-center gap-1 text-left group min-w-0",children:[b.jsx("h1",{className:"text-xl font-bold text-gray-900 leading-tight",children:f.name}),bh(f)&&b.jsx(Sh,{}),b.jsx(e0,{size:16,className:"shrink-0 text-gray-400 group-hover:text-gray-600 transition-colors"})]}),b.jsxs("div",{className:"flex items-center gap-0.5",children:[b.jsx("p",{className:"text-sm text-gray-500",children:f.subtitle}),b.jsx("button",{onClick:c,"aria-label":"Event details",className:"inline-grid h-[22px] w-[22px] shrink-0 place-items-center rounded-full text-gray-400 transition-colors hover:bg-gray-100 hover:text-gray-900",children:b.jsx(Wg,{size:14})})]}),s&&b.jsxs(b.Fragment,{children:[b.jsx("div",{className:"fixed inset-0 z-10",onClick:()=>d(!1)}),b.jsx("div",{className:"absolute left-0 top-full z-20 mt-2 min-w-[200px] rounded-xl border border-gray-200 bg-white p-1 shadow-xl",children:o.map(v=>b.jsxs("button",{onClick:()=>{h(v),d(!1)},className:"flex w-full items-center justify-between rounded-lg px-4 py-2.5 hover:bg-gray-50 text-left",children:[b.jsxs("div",{children:[b.jsxs("div",{className:"flex items-center gap-1.5",children:[b.jsx("span",{className:"text-sm font-semibold text-gray-900",children:v.name}),bh(v)&&b.jsx(Sh,{})]}),b.jsx("div",{className:"text-xs text-gray-400",children:v.subtitle})]}),v.id===f.id&&b.jsx(lu,{size:14,className:"text-blue-500 ml-3 shrink-0"})]},v.id))})]})]})}function f1({checked:o,onChange:f,label:h}){return b.jsxs("label",{style:{display:"flex",alignItems:"center",gap:"8px",cursor:"pointer",userSelect:"none"},children:[h&&b.jsx("span",{style:{fontSize:"14px",color:"#4b5563"},children:h}),b.jsx("button",{type:"button",role:"switch","aria-checked":o,onClick:f,style:{position:"relative",display:"inline-block",width:"44px",height:"24px",borderRadius:"12px",backgroundColor:o?"#000000":"#d1d5db",border:"none",cursor:"pointer",padding:0,flexShrink:0,transition:"background-color 0.2s ease",WebkitTapHighlightColor:"transparent"},children:b.jsx("span",{style:{position:"absolute",top:"2px",left:o?"22px":"2px",width:"20px",height:"20px",borderRadius:"50%",backgroundColor:"white",boxShadow:"0 1px 4px rgba(0,0,0,0.25)",transition:"left 0.2s ease",display:"block"}})})]})}const Jn=72,d1=110;function h1({children:o}){const[f,h]=pt.useState(0),[c,s]=pt.useState("idle"),d=pt.useRef(null),v=pt.useRef(0);pt.useEffect(()=>{const B=H=>{window.scrollY===0&&(d.current=H.touches[0].clientY)},D=H=>{if(d.current===null)return;const O=H.touches[0].clientY-d.current;if(O<=0){d.current=null;return}H.preventDefault();const G=O<Jn?O:Jn+(O-Jn)*.25;v.current=Math.min(G,d1),h(v.current),s("pulling")},U=()=>{d.current!==null&&(d.current=null,v.current>=Jn?(s("refreshing"),h(Jn*.75),setTimeout(()=>window.location.reload(),600)):(s("releasing"),h(0),v.current=0,setTimeout(()=>s("idle"),250)))};return document.addEventListener("touchstart",B,{passive:!0}),document.addEventListener("touchmove",D,{passive:!1}),document.addEventListener("touchend",U),document.addEventListener("touchcancel",U),()=>{document.removeEventListener("touchstart",B),document.removeEventListener("touchmove",D),document.removeEventListener("touchend",U),document.removeEventListener("touchcancel",U)}},[]);const w=c==="releasing"||c==="refreshing",m=Math.min(f/Jn,1),S=f>=Jn;return b.jsxs(b.Fragment,{children:[b.jsx("div",{className:"pointer-events-none fixed inset-x-0 z-50 flex justify-center",style:{top:-44,transform:`translateY(${f}px)`,transition:w?"transform 0.25s ease":"none"},children:b.jsx("div",{className:`flex h-8 w-8 items-center justify-center rounded-full bg-white shadow-md ${S?"text-blue-500":"text-gray-400"}`,children:b.jsx(Pg,{size:16,className:c==="refreshing"?"animate-spin":"",style:c!=="refreshing"?{transform:`rotate(${m*270}deg)`}:void 0})})}),b.jsx("div",{style:{transform:`translateY(${f}px)`,transition:w?"transform 0.25s ease":"none"},children:o})]})}function m1({groups:o}){const f=o.filter(h=>h.description);return f.length===0?null:b.jsxs("div",{className:"mt-2 rounded-2xl border border-gray-200 bg-white p-4 shadow-sm",children:[b.jsx("div",{className:"mb-2 text-xs font-bold uppercase tracking-widest text-gray-400",children:"Legend"}),b.jsx("ul",{className:"flex flex-col gap-1.5",children:f.map(h=>b.jsxs("li",{className:"flex items-center gap-2 text-sm text-gray-700",children:[b.jsx("span",{className:`h-3 w-3 shrink-0 rounded-full ${h.bgClass}`,"aria-hidden":"true"}),b.jsx("span",{className:"font-medium text-gray-900",children:h.label}),b.jsx("span",{className:"text-gray-400",children:"·"}),b.jsx("span",{children:h.description})]},h.id))})]})}const Eh=`// HPDE track-day schedule — iOS Home Screen widget for Scriptable.
...
`,Ih=Ll("test-live",ly),ay={...Ih,days:Ih.days.map(o=>({...o,date:Ba()}))},eu=[J1,I1,$1,ny,ty].sort((o,f)=>f.id.localeCompare(o.id)),Wh=[...eu,ay];function tu(o,f){const[h,c]=pt.useState(()=>{try{const s=localStorage.getItem(o);return s!==null?JSON.parse(s):f}catch{return f}});return pt.useEffect(()=>{localStorage.setItem(o,JSON.stringify(h))},[o,h]),[h,c]}function s0(o){const f=Ba();return o.days.find(h=>h.date===f)}function $h(o){return s0(o)??o.days[0]}function iy(){const[o,f]=pt.useState(()=>window.location.hash);pt.useEffect(()=>{const c=()=>{f(window.location.hash),window.scrollTo(0,0)};return window.addEventListener("hashchange",c),()=>window.removeEventListener("hashchange",c)},[]);function h(c){window.location.hash!==c&&(window.location.hash=c)}return[o,h]}const tr="#/event/";function Ph(o){return`${tr}${encodeURIComponent(o)}`}function uy(o){return o.startsWith(tr)?decodeURIComponent(o.slice(tr.length)):null}function cy(){const[o,f]=iy(),[h,c]=pt.useState("schedule"),[s,d]=tu("hpde:activeEvent",eu[0].id),[v,w]=tu("hpde:activeDay",null),[m,S]=tu("hpde:groups",[]),[B,D]=tu("hpde:hidePast",!1),[U,H]=pt.useState(!1),O=Wh.find(j=>j.id===s)??eu[0],G=O.days.find(j=>j.id===v)??$h(O),it=s0(O),Z=G.date===Ba(),q=O.days.length>1,K=O.days.reduce((j,V)=>V.date>j?V.date:j,O.days[0].date)<Ba(),[,st]=pt.useState(0);pt.useEffect(()=>{if(!Z)return;const j=setInterval(()=>st(V=>V+1),6e4);return()=>clearInterval(j)},[Z]);const Q=Z&&G.events.some(j=>j.type!=="break"&&en(j.time)<nr());function L(j){d(j.id),w($h(j).id),S([]),f(Ph(j.id))}return pt.useEffect(()=>{const j=uy(o);if(j){const V=Wh.find(et=>et.id===j);V&&V.id!==s&&L(V);return}(o===""||o==="#")&&f(Ph(s))},[o]),o==="#/widget-script"?b.jsx(g1,{}):o==="#/share"?b.jsx(q1,{}):b.jsxs(b.Fragment,{children:[b.jsx(h1,{children:b.jsxs("div",{className:"min-h-screen bg-gray-50",children:[b.jsxs("div",{className:"mx-auto max-w-lg px-3 py-4 sm:px-4 sm:py-6",children:[b.jsxs("div",{className:"mb-4 flex items-start justify-between gap-3",children:[b.jsx(s1,{events:eu,active:O,onChange:L,onOpenDetails:()=>H(!0)}),b.jsxs("div",{className:"flex gap-1 rounded-lg bg-gray-100 p-1 shrink-0 self-start",children:[b.jsx("button",{onClick:()=>c("schedule"),className:`rounded-md p-2 transition-colors ${h==="schedule"?"bg-white text-gray-900 shadow-sm":"text-gray-400 hover:text-gray-600"}`,style:{minWidth:36,minHeight:36},children:b.jsx(Jg,{size:18})}),b.jsx("button",{onClick:()=>c("map"),className:`rounded-md p-2 transition-colors ${h==="map"?"bg-white text-gray-900 shadow-sm":"text-gray-400 hover:text-gray-600"}`,style:{minWidth:36,minHeight:36},children:b.jsx(yh,{size:18})})]})]}),K&&b.jsx("div",{className:"mb-4 rounded-lg border border-gray-200 bg-gray-100 px-3 py-2 text-center text-sm text-gray-600",children:"This event has passed."}),h==="schedule"&&b.jsxs(b.Fragment,{children:[q&&b.jsxs("div",{className:"mb-3 flex items-center gap-2",children:[b.jsx("div",{className:"flex flex-1 gap-1 rounded-lg bg-white border border-gray-200 p-1 shadow-sm min-w-0",children:O.days.map(j=>b.jsx("button",{onClick:()=>w(j.id),className:`flex-1 rounded-md py-2 text-sm font-medium capitalize transition-colors ${G.id===j.id?"bg-gray-900 text-white":"text-gray-500 hover:text-gray-800"}`,children:j.label},j.id))}),b.jsx("button",{onClick:()=>it&&w(it.id),disabled:Z||!it,className:`rounded-lg border px-3 py-2 text-sm font-medium transition-colors shrink-0 ${Z||!it?"border-gray-100 bg-white text-gray-300 cursor-default":"border-gray-200 bg-white text-gray-700 shadow-sm hover:border-gray-400"}`,children:"Now"})]}),b.jsxs("div",{className:"mb-4 flex items-center justify-between gap-3",children:[b.jsx(r1,{groups:O.runGroups,selected:m,onChange:S}),Q&&b.jsx(f1,{checked:B,onChange:()=>D(j=>!j),label:"Hide past events"})]}),b.jsx(o1,{events:G.events,runGroups:O.runGroups,isToday:Z,selectedGroups:m,hidePast:B}),b.jsx(m1,{groups:O.runGroups})]}),h==="map"&&(O.mapImage?b.jsx("div",{className:"overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm",children:b.jsx("img",{src:O.mapImage,alt:`${O.name} track map`,className:"block w-full h-auto"})}):b.jsx("div",{className:"flex aspect-[4/3] items-center justify-center rounded-2xl border border-gray-200 bg-white text-gray-400 shadow-sm",children:b.jsxs("div",{className:"text-center",children:[b.jsx(yh,{size:40,className:"mx-auto mb-2 opacity-30"}),b.jsx("p",{className:"text-sm",children:"Track map coming soon"})]})}))]}),b.jsxs("div",{className:"mt-6 pb-8 text-center text-xs",children:[b.jsxs("div",{children:[b.jsx("a",{href:"#/widget-script",className:"text-gray-600 underline hover:text-gray-800",children:"iOS widget"})," · ",b.jsx("a",{href:"#/share",className:"text-gray-600 underline hover:text-gray-800",children:"Share"})]}),b.jsxs("div",{className:"mt-4 font-mono text-[10px] text-gray-300",children:["build ",i1("2026-09-17T12:24:08-05:00")]})]})]})}),b.jsx(V1,{event:O,open:U,onClose:()=>H(!1)})]})}Vg.createRoot(document.getElementById("root")).render(b.jsx(pt.StrictMode,{children:b.jsx(cy,{})}));
