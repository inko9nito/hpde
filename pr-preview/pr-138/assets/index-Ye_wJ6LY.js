 ...
 */var ch;function Bg(){if(ch)return zl;ch=1;var r=Symbol.for("react.transitional.element"),f=Symbol.for("react.fragment");function h(c,o,d){var b=null;if(d!==void 0&&(b=""+d),o.key!==void 0&&(b=""+o.key),"key"in o){d={};for(var E in o)E!=="key"&&(d[E]=o[E])}else d=o;return o=d.ref,{$$typeof:r,type:c,key:b,ref:o!==void 0?o:null,props:d}}return zl.Fragment=f,zl.jsx=h,zl.jsxs=h,zl}var rh;function Hg(){return rh||(rh=1,Er.exports=Bg()),Er.exports}var v=Hg(),Tr={exports:{}},ct={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var fh;function jg(){return fh||(fh=1,(function(r){function f(C,Z){var at=C.length;C.push(Z);t:for(;0<at;){var Tt=at-1>>>1,wt=C[Tt];if(0<o(wt,Z))C[Tt]=Z,C[at]=wt,at=Tt;else break t}}function h(C){return C.length===0?null:C[0]}function c(C){if(C.length===0)return null;var Z=C[0],at=C.pop();if(at!==Z){C[0]=at;t:for(var Tt=0,wt=C.length,y=wt>>>1;Tt<y;){var z=2*(Tt+1)-1,Q=C[z],F=z+1,ut=C[F];if(0>o(Q,at))F<wt&&0>o(ut,Q)?(C[Tt]=ut,C[F]=at,Tt=F):(C[Tt]=Q,C[z]=at,Tt=z);else if(F<wt&&0>o(ut,at))C[Tt]=ut,C[F]=at,Tt=F;else break t}}return Z}function o(C,Z){var at=C.sortIndex-Z.sortIndex;return at!==0?at:C.id-Z.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var d=performance;r.unstable_now=function(){return d.now()}}else{var b=Date,E=b.now();r.unstable_now=function(){return b.now()-E}}var g=[],S=[],O=1,D=null,k=3,B=!1,L=!1,j=!1,nt=!1,G=typeof setTimeout=="function"?setTimeout:null,q=typeof clearTimeout=="function"?clearTimeout:null,Y=typeof setImmediate<"u"?setImmediate:null;function K(C){for(var Z=h(S);Z!==null;){if(Z.callback===null)c(S);else if(Z.startTime<=C)c(S),Z.sortIndex=Z.expirationTime,f(g,Z);else break;Z=h(S)}}function ot(C){if(j=!1,K(C),!L)if(h(g)!==null)L=!0,V||(V=!0,I());else{var Z=h(S);Z!==null&&Lt(ot,Z.startTime-C)}}var V=!1,U=-1,H=5,X=-1;function et(){return nt?!0:!(r.unstable_now()-X<H)}function $(){if(nt=!1,V){var C=r.unstable_now();X=C;var Z=!0;try{t:{L=!1,j&&(j=!1,q(U),U=-1),B=!0;var at=k;try{e:{for(K(C),D=h(g);D!==null&&!(D.expirationTime>C&&et());){var Tt=D.callback;if(typeof Tt=="function"){D.callback=null,k=D.priorityLevel;var wt=Tt(D.expirationTime<=C);if(C=r.unstable_now(),typeof wt=="function"){D.callback=wt,K(C),Z=!0;break e}D===h(g)&&c(g),K(C)}else c(g);D=h(g)}if(D!==null)Z=!0;else{var y=h(S);y!==null&&Lt(ot,y.startTime-C),Z=!1}}break t}finally{D=null,k=at,B=!1}Z=void 0}}finally{Z?I():V=!1}}}var I;if(typeof Y=="function")I=function(){Y($)};else if(typeof MessageChannel<"u"){var P=new MessageChannel,it=P.port2;P.port1.onmessage=$,I=function(){it.postMessage(null)}}else I=function(){G($,0)};function Lt(C,Z){U=G(function(){C(r.unstable_now())},Z)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(C){C.callback=null},r.unstable_forceFrameRate=function(C){0>C||125<C?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):H=0<C?Math.floor(1e3/C):5},r.unstable_getCurrentPriorityLevel=function(){return k},r.unstable_next=function(C){switch(k){case 1:case 2:case 3:var Z=3;break;default:Z=k}var at=k;k=Z;try{return C()}finally{k=at}},r.unstable_requestPaint=function(){nt=!0},r.unstable_runWithPriority=function(C,Z){switch(C){case 1:case 2:case 3:case 4:case 5:break;default:C=3}var at=k;k=C;try{return Z()}finally{k=at}},r.unstable_scheduleCallback=function(C,Z,at){var Tt=r.unstable_now();switch(typeof at=="object"&&at!==null?(at=at.delay,at=typeof at=="number"&&0<at?Tt+at:Tt):at=Tt,C){case 1:var wt=-1;break;case 2:wt=250;break;case 5:wt=1073741823;break;case 4:wt=1e4;break;default:wt=5e3}return wt=at+wt,C={id:O++,callback:Z,priorityLevel:C,startTime:at,expirationTime:wt,sortIndex:-1},at>Tt?(C.sortIndex=at,f(S,C),h(g)===null&&C===h(S)&&(j?(q(U),U=-1):j=!0,Lt(ot,at-Tt))):(C.sortIndex=wt,f(g,C),L||B||(L=!0,V||(V=!0,I()))),C},r.unstable_shouldYield=et,r.unstable_wrapCallback=function(C){var Z=k;return function(){var at=k;k=Z;try{return C.apply(this,arguments)}finally{k=at}}}})(Nr)),Nr}var dh;function Lg(){return dh||(dh=1,Ar.exports=jg()),Ar.exports}var Cr={exports:{}},$t={};/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Kg=vt.forwardRef(({color:r="currentColor",size:f=24,strokeWidth:h=2,absoluteStrokeWidth:c,className:o="",children:d,iconNode:b,...E},g)=>vt.createElement("svg",{ref:g,...Zg,width:f,height:f,stroke:r,strokeWidth:c?Number(h)*24/Number(f):h,className:e0("lucide",o),...E},[...b.map(([S,O])=>vt.createElement(S,O)),...Array.isArray(d)?d:[d]]));/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ce=(r,f)=>{const h=vt.forwardRef(({className:c,...o},d)=>vt.createElement(Kg,{ref:d,iconNode:f,className:e0(`lucide-${Xg(r)}`,c),...o}));return h.displayName=`${r}`,h};/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const au=Ce("Check",[["path",{d:"M20 6 9 17l-5-5",key:"1gmf2c"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const a0=Ce("Copy",[["rect",{width:"14",height:"14",x:"8",y:"8",rx:"2",ry:"2",key:"17jyea"}],["path",{d:"M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2",key:"zix9uf"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const es=Ce("X",[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]]);function nu({group:r,size:f="md",dim:h}){const c=f==="sm"?"px-2 py-0.5 text-xs":"px-3 py-1 text-sm";return v.jsx("span",{className:`inline-flex items-center rounded-full font-semibold ${r.bgClass} ${r.textClass} ${c} ${h?"opacity-40":""}`,children:r.label})}function en(r){const[f,h]=r.split(":").map(Number);return f*60+h}const e1=30;function n1(r,f){let h=-1;for(let E=0;E<r.length&&en(r[E])<=f;E++)h=E;if(h===-1)return{index:-1,progress:0};const c=en(r[h]),o=r[h+1]?en(r[h+1]):null,d=o!==null?o:c+e1;if(f>=d)return{index:-1,progress:0};const b=d===c?0:(f-c)/(d-c);return{index:h,progress:Math.max(0,Math.min(1,b))}}function l0(r){const[f,h]=r.split(":").map(Number);return`${f%12||12}:${h.toString().padStart(2,"0")}`}function i0(r){const[f]=r.split(":").map(Number);return f>=12?"PM":"AM"}function ns(){const r=new Date;return r.getHours()*60+r.getMinutes()}function kl(){const r=new Date,f=r.getFullYear(),h=String(r.getMonth()+1).padStart(2,"0"),c=String(r.getDate()).padStart(2,"0");return`${f}-${h}-${c}`}function a1(){const r=new Date,f=r.getHours(),h=r.getMinutes(),c=f%12||12,o=f>=12?"PM":"AM";return`${c}:${h.toString().padStart(2,"0")} ${o}`}function l1(r){if(r<=0)return"";if(r<60)return`${r} min`;const f=Math.floor(r/60),h=r%60;return h===0?`${f}h`:`${f}h ${h}m`}function i1(r){const f=new Date(r);if(isNaN(f.getTime()))return r;const h=f.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"}),c=f.toLocaleTimeString(void 0,{hour:"numeric",minute:"2-digit"});return`${h}, ${c}`}function vh(r,f){return r.flatMap(h=>{const c=f.find(o=>o.id===h);return c?[c]:[]})}function u1({event:r,runGroups:f,past:h}){const c=vh(r.onTrack,f),o=vh(r.inClass??[],f);return v.jsx("div",{className:`rounded-xl border border-gray-200 bg-white p-4 shadow-sm transition-opacity ${h?"opacity-60":""}`,children:v.jsxs("div",{className:"flex gap-4",children:[v.jsxs("div",{className:"flex w-20 shrink-0 items-baseline gap-0.5 font-mono text-lg font-semibold text-gray-900",children:[l0(r.time),v.jsx("span",{className:"font-sans text-[10px] font-normal text-gray-400",children:i0(r.time)})]}),v.jsxs("div",{className:"flex flex-1 flex-col gap-3",children:[c.length>0&&v.jsxs("div",{className:"flex items-center gap-3",children:[v.jsx("span",{className:"w-16 shrink-0 text-xs text-gray-900",children:"On track"}),v.jsx("div",{className:"flex flex-wrap gap-1.5",children:c.map(d=>v.jsx(nu,{group:d},d.id))})]}),o.length>0&&v.jsxs(v.Fragment,{children:[c.length>0&&v.jsx("div",{className:"border-t border-gray-100"}),v.jsxs("div",{className:"flex items-center gap-3",children:[v.jsx("span",{className:"w-16 shrink-0 text-xs text-gray-900",children:"In class"}),v.jsx("div",{className:"flex flex-wrap gap-1.5",children:o.map(d=>v.jsx(nu,{group:d},d.id))})]})]}),r.note&&v.jsx("p",{className:"text-xs italic text-gray-500",children:r.note})]})]})})}function c1({event:r,past:f}){const h=r.type==="lunch"||r.type==="special";return v.jsx("div",{className:`rounded-xl p-4 shadow-sm transition-opacity ${h?"border-2 border-gray-900 bg-white my-2":"border border-gray-200 bg-white"} ${f?"opacity-60":""}`,children:v.jsxs("div",{className:"flex items-center gap-4",children:[v.jsxs("div",{className:"flex w-20 shrink-0 items-baseline gap-0.5 font-mono text-lg font-semibold text-gray-900",children:[l0(r.time),v.jsx("span",{className:"font-sans text-[10px] font-normal text-gray-400",children:i0(r.time)})]}),h&&v.jsx("div",{className:"flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-gray-900 text-white",children:r.type==="lunch"?v.jsx(t1,{size:16}):v.jsx($g,{size:16})}),v.jsxs("div",{children:[v.jsx("p",{className:"text-sm font-medium text-gray-900",children:r.label}),r.subtitle&&v.jsx("p",{className:"mt-0.5 text-xs text-gray-500",children:r.subtitle})]})]})})}const $r=vt.forwardRef(({events:r},f)=>{const[,h]=vt.useState(0);vt.useEffect(()=>{const g=setInterval(()=>h(S=>S+1),3e4);return()=>clearInterval(g)},[]);const c=ns(),d=r.filter(g=>"time"in g).find(g=>en(g.time)>c),b=d?en(d.time)-c:null,E=b!==null?b<=5?"text-red-500":b<=10?"text-orange-500":"text-gray-400":"text-gray-400";return v.jsxs("div",{ref:f,"data-time-indicator":!0,className:"relative my-6",children:[v.jsxs("div",{className:"flex items-center -mr-3 sm:-mr-4",children:[v.jsx("div",{className:"h-2.5 w-2.5 shrink-0 rounded-full bg-blue-500"}),v.jsx("div",{className:"h-0.5 flex-1 bg-blue-500"})]}),v.jsx("span",{className:"absolute left-4 -top-5 font-mono text-xs font-semibold text-blue-500",children:a1()}),b!==null&&v.jsxs("span",{className:`absolute right-0 -top-5 text-xs ${E}`,children:["Next event starts in ",v.jsx("span",{className:"font-semibold",children:l1(b)})]})]})});$r.displayName="TimeIndicator";function bh({collapsed:r,children:f}){return v.jsx("div",{"data-collapsed":r,"aria-hidden":r,className:"grid transition-[grid-template-rows,opacity,margin-bottom] duration-300 ease-in-out",style:{gridTemplateRows:r?"0fr":"1fr",opacity:r?0:1,marginBottom:r?0:"0.5rem"},children:v.jsx("div",{className:"overflow-hidden",children:f})})}function r1({events:r,runGroups:f,isToday:h,selectedGroups:c,hidePast:o}){const d=vt.useRef(null),[,b]=vt.useState(0);vt.useEffect(()=>{if(!h)return;const q=setInterval(()=>b(Y=>Y+1),6e4);return()=>clearInterval(q)},[h]),vt.useEffect(()=>{if(!h)return;const q=setTimeout(()=>{var Y;(Y=d.current)==null||Y.scrollIntoView({behavior:"smooth",block:"center"})},150);return()=>clearTimeout(q)},[h]);const E=ns(),g=r.flatMap(q=>{if(q.type!=="session")return[q];if(c.length===0)return[q];const Y=q.onTrack.filter(ot=>c.includes(ot)),K=(q.inClass??[]).filter(ot=>c.includes(ot));return Y.length===0&&K.length===0?[]:[{...q,onTrack:Y,inClass:K}]}),S=g.map(q=>q.type!=="break"&&o&&h&&en(q.time)<E);g.forEach((q,Y)=>{if(q.type!=="break")return;const K=g.slice(0,Y).some((ot,V)=>ot.type!=="break"&&!S[V]);S[Y]=!K});const O=[],D=[];g.forEach((q,Y)=>{q.type!=="break"&&(O.push(Y),D.push(q.time))});const{index:k}=h?n1(D,E):{index:-1},B=k===-1?-1:O[k],L=h?g.findIndex(q=>q.type!=="break"&&en(q.time)>E):-1,j=h&&L===-1&&g.length>0,nt=g.length>0&&S.every(Boolean);let G;return v.jsxs("div",{className:"flex flex-col pb-10",children:[g.length>0&&v.jsx(bh,{collapsed:!nt,children:v.jsxs("div",{className:"flex flex-col items-center gap-1 rounded-2xl border border-gray-200 bg-white px-6 py-10 text-center shadow-sm",children:[v.jsx("p",{className:"text-sm font-medium text-gray-500",children:"That's a wrap for today"}),v.jsx("p",{className:"text-xs text-gray-400",children:"Every event on today's schedule has already happened."})]})}),g.map((q,Y)=>{const K=Y===B,ot=h&&q.type!=="break"&&!K&&en(q.time)<E;let V=null;!S[Y]&&q.type==="session"&&q.sessionNumber!==void 0&&q.sessionNumber!==G&&(G=q.sessionNumber,V=v.jsxs("div",{className:"mt-5 mb-1 text-xs font-bold uppercase tracking-widest text-gray-400",children:["Session ",q.sessionNumber]}));const U=q.type==="break"?v.jsxs("div",{className:"flex items-center gap-2 py-1",children:[v.jsx("div",{className:"h-px flex-1 bg-gray-200"}),v.jsx("span",{className:"text-xs text-gray-400 italic",children:q.label}),v.jsx("div",{className:"h-px flex-1 bg-gray-200"})]}):q.type==="session"?v.jsx(u1,{event:q,runGroups:f,past:ot}):v.jsx(c1,{event:q,past:ot});return v.jsxs(bh,{collapsed:S[Y],children:[Y===L&&v.jsx($r,{ref:d,events:g}),V,U]},Y)}),j&&v.jsx($r,{ref:d,events:g})]})}function s1({groups:r,selected:f,onChange:h}){const[c,o]=vt.useState(!1),d=g=>h(f.includes(g)?f.filter(S=>S!==g):[...f,g]),b=f.length===0||f.length===r.length,E=r.filter(g=>f.includes(g.id));return v.jsxs("div",{className:"relative",children:[v.jsxs("button",{onClick:()=>o(g=>!g),className:"flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-3 py-1.5 text-sm shadow-sm transition-colors hover:border-gray-400",children:[b?v.jsx("span",{className:"text-gray-700",children:"All run groups"}):v.jsx("div",{className:"flex items-center gap-1",children:E.map(g=>v.jsx(nu,{group:g,size:"sm"},g.id))}),v.jsx(n0,{size:14,className:"text-gray-400"})]}),c&&v.jsxs(v.Fragment,{children:[v.jsx("div",{className:"fixed inset-0 z-10",onClick:()=>o(!1)}),v.jsxs("div",{className:"absolute left-0 top-full z-20 mt-1 min-w-[180px] rounded-xl border border-gray-200 bg-white p-1 shadow-xl",children:[r.map(g=>v.jsxs("button",{onClick:()=>d(g.id),className:"flex w-full items-center justify-between rounded-lg px-3 py-2 hover:bg-gray-50",children:[v.jsx(nu,{group:g,size:"md"}),f.includes(g.id)&&v.jsx(au,{size:14,className:"text-blue-500"})]},g.id)),v.jsx("div",{className:"mt-1 border-t border-gray-100 pt-1",children:v.jsx("button",{onClick:()=>{h([]),o(!1)},className:"w-full rounded-lg px-3 py-2 text-left text-sm text-gray-400 hover:bg-gray-50",children:b?"All selected":"Clear filter"})})]})]})]})}function Sh(r){const f=kl();return r.days.some(h=>h.date===f)}function wh(){return v.jsxs("span",{className:"ml-2 inline-flex shrink-0 items-center gap-1 rounded-full bg-green-100 px-1.5 py-px text-[9px] font-semibold uppercase tracking-wide text-green-700",children:[v.jsx("span",{className:"h-1 w-1 rounded-full bg-green-700 animate-pulse"}),"Live"]})}function o1({events:r,active:f,onChange:h,onOpenDetails:c}){const[o,d]=vt.useState(!1);return v.jsxs("div",{className:"relative min-w-0 pl-1",children:[v.jsxs("button",{onClick:()=>d(b=>!b),className:"flex items-center gap-1 text-left group min-w-0",children:[v.jsx("h1",{className:"text-xl font-bold text-gray-900 leading-tight",children:f.name}),Sh(f)&&v.jsx(wh,{}),v.jsx(n0,{size:16,className:"shrink-0 text-gray-400 group-hover:text-gray-600 transition-colors"})]}),v.jsxs("div",{className:"flex items-center gap-0.5",children:[v.jsx("p",{className:"text-sm text-gray-500",children:f.subtitle}),v.jsx("button",{onClick:c,"aria-label":"Event details",className:"inline-grid h-[22px] w-[22px] shrink-0 place-items-center rounded-full text-gray-400 transition-colors hover:bg-gray-100 hover:text-gray-900",children:v.jsx(Wg,{size:14})})]}),o&&v.jsxs(v.Fragment,{children:[v.jsx("div",{className:"fixed inset-0 z-10",onClick:()=>d(!1)}),v.jsx("div",{className:"absolute left-0 top-full z-20 mt-2 min-w-[200px] rounded-xl border border-gray-200 bg-white p-1 shadow-xl",children:r.map(b=>v.jsxs("button",{onClick:()=>{h(b),d(!1)},className:"flex w-full items-center justify-between rounded-lg px-4 py-2.5 hover:bg-gray-50 text-left",children:[v.jsxs("div",{children:[v.jsxs("div",{className:"flex items-center gap-1.5",children:[v.jsx("span",{className:"text-sm font-semibold text-gray-900",children:b.name}),Sh(b)&&v.jsx(wh,{})]}),v.jsx("div",{className:"text-xs text-gray-400",children:b.subtitle})]}),b.id===f.id&&v.jsx(au,{size:14,className:"text-blue-500 ml-3 shrink-0"})]},b.id))})]})]})}function f1({checked:r,onChange:f,label:h}){return v.jsxs("label",{style:{display:"flex",alignItems:"center",gap:"8px",cursor:"pointer",userSelect:"none"},children:[h&&v.jsx("span",{style:{fontSize:"14px",color:"#4b5563"},children:h}),v.jsx("button",{type:"button",role:"switch","aria-checked":r,onClick:f,style:{position:"relative",display:"inline-block",width:"44px",height:"24px",borderRadius:"12px",backgroundColor:r?"#000000":"#d1d5db",border:"none",cursor:"pointer",padding:0,flexShrink:0,transition:"background-color 0.2s ease",WebkitTapHighlightColor:"transparent"},children:v.jsx("span",{style:{position:"absolute",top:"2px",left:r?"22px":"2px",width:"20px",height:"20px",borderRadius:"50%",backgroundColor:"white",boxShadow:"0 1px 4px rgba(0,0,0,0.25)",transition:"left 0.2s ease",display:"block"}})})]})}const Jn=72,d1=110;function h1({children:r}){const[f,h]=vt.useState(0),[c,o]=vt.useState("idle"),d=vt.useRef(null),b=vt.useRef(0);vt.useEffect(()=>{const O=B=>{window.scrollY===0&&(d.current=B.touches[0].clientY)},D=B=>{if(d.current===null)return;const L=B.touches[0].clientY-d.current;if(L<=0){d.current=null;return}B.preventDefault();const j=L<Jn?L:Jn+(L-Jn)*.25;b.current=Math.min(j,d1),h(b.current),o("pulling")},k=()=>{d.current!==null&&(d.current=null,b.current>=Jn?(o("refreshing"),h(Jn*.75),setTimeout(()=>window.location.reload(),600)):(o("releasing"),h(0),b.current=0,setTimeout(()=>o("idle"),250)))};return document.addEventListener("touchstart",O,{passive:!0}),document.addEventListener("touchmove",D,{passive:!1}),document.addEventListener("touchend",k),document.addEventListener("touchcancel",k),()=>{document.removeEventListener("touchstart",O),document.removeEventListener("touchmove",D),document.removeEventListener("touchend",k),document.removeEventListener("touchcancel",k)}},[]);const E=c==="releasing"||c==="refreshing",g=Math.min(f/Jn,1),S=f>=Jn;return v.jsxs(v.Fragment,{children:[v.jsx("div",{className:"pointer-events-none fixed inset-x-0 z-50 flex justify-center",style:{top:-44,transform:`translateY(${f}px)`,transition:E?"transform 0.25s ease":"none"},children:v.jsx("div",{className:`flex h-8 w-8 items-center justify-center rounded-full bg-white shadow-md ${S?"text-blue-500":"text-gray-400"}`,children:v.jsx(Pg,{size:16,className:c==="refreshing"?"animate-spin":"",style:c!=="refreshing"?{transform:`rotate(${g*270}deg)`}:void 0})})}),v.jsx("div",{style:{transform:`translateY(${f}px)`,transition:E?"transform 0.25s ease":"none"},children:r})]})}function m1({groups:r}){const f=r.filter(h=>h.description);return f.length===0?null:v.jsxs("div",{className:"mt-2 rounded-2xl border border-gray-200 bg-white p-4 shadow-sm",children:[v.jsx("div",{className:"mb-2 text-xs font-bold uppercase tracking-widest text-gray-400",children:"Legend"}),v.jsx("ul",{className:"flex flex-col gap-1.5",children:f.map(h=>v.jsxs("li",{className:"flex items-center gap-2 text-sm text-gray-700",children:[v.jsx("span",{className:`h-3 w-3 shrink-0 rounded-full ${h.bgClass}`,"aria-hidden":"true"}),v.jsx("span",{className:"font-medium text-gray-900",children:h.label}),v.jsx("span",{className:"text-gray-400",children:"·"}),v.jsx("span",{children:h.description})]},h.id))})]})}const Eh=`// HPDE track-day schedule — iOS Home Screen widget for Scriptable.
...
`,K1="/hpde/pr-preview/pr-138/assets/msrc-1-7-D9G0r_nf.jpg",J1={...ja("2026-09-11_msrc-1-7",Z1),mapImage:K1},F1=`# TXR SCCA
...
`,I1=ja("2026-09-13_msr-scca",F1),W1=`# MSRC 1.7 Fast Track
...
`,$1=ja("2026-06-06_msrc-1-7",W1),P1=`# MSRC 3.1
...
`,tp=ja("2025-11-07_msrc-3-1",P1),ep=`# ECR 2.7
...
`,np=ja("2026-05-30_ecr-2-7",ep),ap=`# Test Event
...
`,Wh=ja("test-live",ap),lp={...Wh,days:Wh.days.map(r=>({...r,date:kl()}))},eu=[J1,I1,$1,np,tp].sort((r,f)=>f.id.localeCompare(r.id)),$h=[...eu,lp];function tu(r,f){const[h,c]=vt.useState(()=>{try{const o=localStorage.getItem(r);return o!==null?JSON.parse(o):f}catch{return f}});return vt.useEffect(()=>{localStorage.setItem(r,JSON.stringify(h))},[r,h]),[h,c]}function o0(r){const f=kl();return r.days.find(h=>h.date===f)}function Ph(r){return o0(r)??r.days[0]}function ip(){const[r,f]=vt.useState(()=>window.location.hash);vt.useEffect(()=>{const c=()=>{f(window.location.hash),window.scrollTo(0,0)};return window.addEventListener("hashchange",c),()=>window.removeEventListener("hashchange",c)},[]);function h(c){window.location.hash!==c&&(window.location.hash=c)}return[r,h]}const Pr="#/event/";function t0(r){return`${Pr}${encodeURIComponent(r)}`}function up(r){return r.startsWith(Pr)?decodeURIComponent(r.slice(Pr.length)):null}function cp(){const[r,f]=ip(),[h,c]=vt.useState("schedule"),[o,d]=tu("hpde:activeEvent",eu[0].id),[b,E]=tu("hpde:activeDay",null),[g,S]=tu("hpde:groups",[]),[O,D]=tu("hpde:hidePast",!1),[k,B]=vt.useState(!1),L=$h.find(H=>H.id===o)??eu[0],j=L.days.find(H=>H.id===b)??Ph(L),nt=o0(L),G=j.date===kl(),q=L.days.length>1,K=L.days.reduce((H,X)=>X.date>H?X.date:H,L.days[0].date)<kl(),[,ot]=vt.useState(0);vt.useEffect(()=>{if(!G)return;const H=setInterval(()=>ot(X=>X+1),6e4);return()=>clearInterval(H)},[G]);const V=G&&j.events.some(H=>H.type!=="break"&&en(H.time)<ns());function U(H){d(H.id),E(Ph(H).id),S([]),f(t0(H.id))}return vt.useEffect(()=>{const H=up(r);if(H){const X=$h.find(et=>et.id===H);X&&X.id!==o&&U(X);return}(r===""||r==="#")&&f(t0(o))},[r]),r==="#/widget-script"?v.jsx(g1,{}):r==="#/share"?v.jsx(L1,{}):v.jsxs(v.Fragment,{children:[v.jsx(h1,{children:v.jsxs("div",{className:"min-h-screen bg-gray-50",children:[v.jsxs("div",{className:"mx-auto max-w-lg px-3 py-4 sm:px-4 sm:py-6",children:[v.jsxs("div",{className:"mb-4 flex items-start justify-between gap-3",children:[v.jsx(o1,{events:eu,active:L,onChange:U,onOpenDetails:()=>B(!0)}),v.jsxs("div",{className:"flex gap-1 rounded-lg bg-gray-100 p-1 shrink-0 self-start",children:[v.jsx("button",{onClick:()=>c("schedule"),className:`rounded-md p-2 transition-colors ${h==="schedule"?"bg-white text-gray-900 shadow-sm":"text-gray-400 hover:text-gray-600"}`,style:{minWidth:36,minHeight:36},children:v.jsx(Jg,{size:18})}),v.jsx("button",{onClick:()=>c("map"),className:`rounded-md p-2 transition-colors ${h==="map"?"bg-white text-gray-900 shadow-sm":"text-gray-400 hover:text-gray-600"}`,style:{minWidth:36,minHeight:36},children:v.jsx(yh,{size:18})})]})]}),K&&v.jsx("div",{className:"mb-4 rounded-lg border border-gray-200 bg-gray-100 px-3 py-2 text-center text-sm text-gray-600",children:"This event has passed."}),h==="schedule"&&v.jsxs(v.Fragment,{children:[q&&v.jsxs("div",{className:"mb-3 flex items-center gap-2",children:[v.jsx("div",{className:"flex flex-1 gap-1 rounded-lg bg-white border border-gray-200 p-1 shadow-sm min-w-0",children:L.days.map(H=>v.jsx("button",{onClick:()=>E(H.id),className:`flex-1 rounded-md py-2 text-sm font-medium capitalize transition-colors ${j.id===H.id?"bg-gray-900 text-white":"text-gray-500 hover:text-gray-800"}`,children:H.label},H.id))}),v.jsx("button",{onClick:()=>nt&&E(nt.id),disabled:G||!nt,className:`rounded-lg border px-3 py-2 text-sm font-medium transition-colors shrink-0 ${G||!nt?"border-gray-100 bg-white text-gray-300 cursor-default":"border-gray-200 bg-white text-gray-700 shadow-sm hover:border-gray-400"}`,children:"Now"})]}),v.jsxs("div",{className:"mb-4 flex items-center justify-between gap-3",children:[v.jsx(s1,{groups:L.runGroups,selected:g,onChange:S}),V&&v.jsx(f1,{checked:O,onChange:()=>D(H=>!H),label:"Hide past events"})]}),v.jsx(r1,{events:j.events,runGroups:L.runGroups,isToday:G,selectedGroups:g,hidePast:O}),v.jsx(m1,{groups:L.runGroups})]}),h==="map"&&(L.mapImage?v.jsx("div",{className:"overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm",children:v.jsx("img",{src:L.mapImage,alt:`${L.name} track map`,className:"block w-full h-auto"})}):v.jsx("div",{className:"flex aspect-[4/3] items-center justify-center rounded-2xl border border-gray-200 bg-white text-gray-400 shadow-sm",children:v.jsxs("div",{className:"text-center",children:[v.jsx(yh,{size:40,className:"mx-auto mb-2 opacity-30"}),v.jsx("p",{className:"text-sm",children:"Track map coming soon"})]})}))]}),v.jsxs("div",{className:"mt-6 pb-8 text-center text-xs",children:[v.jsxs("div",{children:[v.jsx("a",{href:"#/widget-script",className:"text-gray-600 underline hover:text-gray-800",children:"iOS widget"})," · ",v.jsx("a",{href:"#/share",className:"text-gray-600 underline hover:text-gray-800",children:"Share"})]}),v.jsxs("div",{className:"mt-4 font-mono text-[10px] text-gray-300",children:["build ",i1("2026-09-17T15:49:12-05:00")]})]})]})}),v.jsx(V1,{event:L,open:k,onClose:()=>B(!1)})]})}Vg.createRoot(document.getElementById("root")).render(v.jsx(vt.StrictMode,{children:v.jsx(cp,{})}));
