 ...
 */var ah;function Dg(){if(ah)return _a;ah=1;var r=Symbol.for("react.transitional.element"),f=Symbol.for("react.fragment");function h(c,s,d){var S=null;if(d!==void 0&&(S=""+d),s.key!==void 0&&(S=""+s.key),"key"in s){d={};for(var w in s)w!=="key"&&(d[w]=s[w])}else d=s;return s=d.ref,{$$typeof:r,type:c,key:S,ref:s!==void 0?s:null,props:d}}return _a.Fragment=f,_a.jsx=h,_a.jsxs=h,_a}var ih;function Og(){return ih||(ih=1,Eo.exports=Dg()),Eo.exports}var E=Og(),wo={exports:{}},ut={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Vg=vt.forwardRef(({color:r="currentColor",size:f=24,strokeWidth:h=2,absoluteStrokeWidth:c,className:s="",children:d,iconNode:S,...w},g)=>vt.createElement("svg",{ref:g,...Qg,width:f,height:f,stroke:r,strokeWidth:c?Number(h)*24/Number(f):h,className:Wh("lucide",s),...w},[...S.map(([v,M])=>vt.createElement(v,M)),...Array.isArray(d)?d:[d]]));/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ue=(r,f)=>{const h=vt.forwardRef(({className:c,...s},d)=>vt.createElement(Vg,{ref:d,iconNode:f,className:Wh(`lucide-${Yg(r)}`,c),...s}));return h.displayName=`${r}`,h};/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const $h=Ue("ChevronDown",[["path",{d:"m6 9 6 6 6-6",key:"qrunsl"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ph=Ue("Copy",[["rect",{width:"14",height:"14",x:"8",y:"8",rx:"2",ry:"2",key:"17jyea"}],["path",{d:"M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2",key:"zix9uf"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Zg=Ue("ExternalLink",[["path",{d:"M15 3h6v6",key:"1q9fwt"}],["path",{d:"M10 14 21 3",key:"gplh6r"}],["path",{d:"M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6",key:"a6xqqp"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Kg=Ue("Pizza",[["path",{d:"m12 14-1 1",key:"11onhr"}],["path",{d:"m13.75 18.25-1.25 1.42",key:"1yisr3"}],["path",{d:"M17.775 5.654a15.68 15.68 0 0 0-12.121 12.12",key:"1qtqk6"}],["path",{d:"M18.8 9.3a1 1 0 0 0 2.1 7.7",key:"fbbbr2"}],["path",{d:"M21.964 20.732a1 1 0 0 1-1.232 1.232l-18-5a1 1 0 0 1-.695-1.232A19.68 19.68 0 0 1 15.732 2.037a1 1 0 0 1 1.232.695z",key:"1hyfdd"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Jg=Ue("RefreshCw",[["path",{d:"M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8",key:"v9h5vc"}],["path",{d:"M21 3v5h-5",key:"1q7to0"}],["path",{d:"M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16",key:"3uifl3"}],["path",{d:"M8 16H3v5",key:"1cv678"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Fg=Ue("Utensils",[["path",{d:"M3 2v7c0 1.1.9 2 2 2h4a2 2 0 0 0 2-2V2",key:"cjf0a3"}],["path",{d:"M7 2v20",key:"1473qp"}],["path",{d:"M21 15V2a5 5 0 0 0-5 5v6c0 1.1.9 2 2 2h3Zm0 0v7",key:"j28e5"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const t0=Ue("X",[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]]);function tu({group:r,size:f="md",dim:h}){const c=f==="sm"?"px-2 py-0.5 text-xs":"px-3 py-1 text-sm";return E.jsx("span",{className:`inline-flex items-center rounded-full font-semibold ${r.bgClass} ${r.textClass} ${c} ${h?"opacity-40":""}`,children:r.label})}function en(r){const[f,h]=r.split(":").map(Number);return f*60+h}const Ig=30;function Wg(r,f){let h=-1;for(let w=0;w<r.length&&en(r[w])<=f;w++)h=w;if(h===-1)return{index:-1,progress:0};const c=en(r[h]),s=r[h+1]?en(r[h+1]):null,d=s!==null?s:c+Ig;if(f>=d)return{index:-1,progress:0};const S=d===c?0:(f-c)/(d-c);return{index:h,progress:Math.max(0,Math.min(1,S))}}function e0(r){const[f,h]=r.split(":").map(Number);return`${f%12||12}:${h.toString().padStart(2,"0")}`}function n0(r){const[f]=r.split(":").map(Number);return f>=12?"PM":"AM"}function tr(){const r=new Date;return r.getHours()*60+r.getMinutes()}function za(){const r=new Date,f=r.getFullYear(),h=String(r.getMonth()+1).padStart(2,"0"),c=String(r.getDate()).padStart(2,"0");return`${f}-${h}-${c}`}function $g(){const r=new Date,f=r.getHours(),h=r.getMinutes(),c=f%12||12,s=f>=12?"PM":"AM";return`${c}:${h.toString().padStart(2,"0")} ${s}`}function Pg(r){if(r<=0)return"";if(r<60)return`${r} min`;const f=Math.floor(r/60),h=r%60;return h===0?`${f}h`:`${f}h ${h}m`}function t1(r){const f=new Date(r);if(isNaN(f.getTime()))return r;const h=f.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"}),c=f.toLocaleTimeString(void 0,{hour:"numeric",minute:"2-digit"});return`${h}, ${c}`}function gh(r,f){return r.flatMap(h=>{const c=f.find(s=>s.id===h);return c?[c]:[]})}function e1({event:r,runGroups:f,past:h}){const c=gh(r.onTrack,f),s=gh(r.inClass??[],f);return E.jsx("div",{className:`rounded-xl border border-gray-200 bg-white p-4 shadow-sm transition-opacity ${h?"opacity-60":""}`,children:E.jsxs("div",{className:"flex gap-4",children:[E.jsxs("div",{className:"flex w-20 shrink-0 items-baseline gap-0.5 font-mono text-lg font-semibold text-gray-900",children:[e0(r.time),E.jsx("span",{className:"font-sans text-[10px] font-normal text-gray-400",children:n0(r.time)})]}),E.jsxs("div",{className:"flex flex-1 flex-col gap-3",children:[c.length>0&&E.jsxs("div",{className:"flex items-center gap-3",children:[E.jsx("span",{className:"w-16 shrink-0 text-xs text-gray-900",children:"On track"}),E.jsx("div",{className:"flex flex-wrap gap-1.5",children:c.map(d=>E.jsx(tu,{group:d},d.id))})]}),s.length>0&&E.jsxs(E.Fragment,{children:[c.length>0&&E.jsx("div",{className:"border-t border-gray-100"}),E.jsxs("div",{className:"flex items-center gap-3",children:[E.jsx("span",{className:"w-16 shrink-0 text-xs text-gray-900",children:"In class"}),E.jsx("div",{className:"flex flex-wrap gap-1.5",children:s.map(d=>E.jsx(tu,{group:d},d.id))})]})]}),r.note&&E.jsx("p",{className:"text-xs italic text-gray-500",children:r.note})]})]})})}function n1({event:r,past:f}){const h=r.type==="lunch"||r.type==="special";return E.jsx("div",{className:`rounded-xl p-4 shadow-sm transition-opacity ${h?"border-2 border-gray-900 bg-white my-2":"border border-gray-200 bg-white"} ${f?"opacity-60":""}`,children:E.jsxs("div",{className:"flex items-center gap-4",children:[E.jsxs("div",{className:"flex w-20 shrink-0 items-baseline gap-0.5 font-mono text-lg font-semibold text-gray-900",children:[e0(r.time),E.jsx("span",{className:"font-sans text-[10px] font-normal text-gray-400",children:n0(r.time)})]}),h&&E.jsx("div",{className:"flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-gray-900 text-white",children:r.type==="lunch"?E.jsx(Fg,{size:16}):E.jsx(Kg,{size:16})}),E.jsxs("div",{children:[E.jsx("p",{className:"text-sm font-medium text-gray-900",children:r.label}),r.subtitle&&E.jsx("p",{className:"mt-0.5 text-xs text-gray-500",children:r.subtitle})]})]})})}const Wo=vt.forwardRef(({events:r},f)=>{const[,h]=vt.useState(0);vt.useEffect(()=>{const g=setInterval(()=>h(v=>v+1),3e4);return()=>clearInterval(g)},[]);const c=tr(),d=r.filter(g=>"time"in g).find(g=>en(g.time)>c),S=d?en(d.time)-c:null,w=S!==null?S<=5?"text-red-500":S<=10?"text-orange-500":"text-gray-400":"text-gray-400";return E.jsxs("div",{ref:f,"data-time-indicator":!0,className:"relative my-6",children:[E.jsxs("div",{className:"flex items-center -mr-3 sm:-mr-4",children:[E.jsx("div",{className:"h-2.5 w-2.5 shrink-0 rounded-full bg-blue-500"}),E.jsx("div",{className:"h-0.5 flex-1 bg-blue-500"})]}),E.jsx("span",{className:"absolute left-4 -top-5 font-mono text-xs font-semibold text-blue-500",children:$g()}),S!==null&&E.jsxs("span",{className:`absolute right-0 -top-5 text-xs ${w}`,children:["Next event starts in ",E.jsx("span",{className:"font-semibold",children:Pg(S)})]})]})});Wo.displayName="TimeIndicator";function yh({collapsed:r,children:f}){return E.jsx("div",{"data-collapsed":r,"aria-hidden":r,className:"grid transition-[grid-template-rows,opacity,margin-bottom] duration-300 ease-in-out",style:{gridTemplateRows:r?"0fr":"1fr",opacity:r?0:1,marginBottom:r?0:"0.5rem"},children:E.jsx("div",{className:"overflow-hidden",children:f})})}function l1({events:r,runGroups:f,isToday:h,selectedGroups:c,hidePast:s}){const d=vt.useRef(null),[,S]=vt.useState(0);vt.useEffect(()=>{if(!h)return;const L=setInterval(()=>S(q=>q+1),6e4);return()=>clearInterval(L)},[h]),vt.useEffect(()=>{if(!h)return;const L=setTimeout(()=>{var q;(q=d.current)==null||q.scrollIntoView({behavior:"smooth",block:"center"})},150);return()=>clearTimeout(L)},[h]);const w=tr(),g=r.flatMap(L=>{if(L.type!=="session")return[L];if(c.length===0)return[L];const q=L.onTrack.filter(ot=>c.includes(ot)),V=(L.inClass??[]).filter(ot=>c.includes(ot));return q.length===0&&V.length===0?[]:[{...L,onTrack:q,inClass:V}]}),v=g.map(L=>L.type!=="break"&&s&&h&&en(L.time)<w);g.forEach((L,q)=>{if(L.type!=="break")return;const V=g.slice(0,q).some((ot,U)=>ot.type!=="break"&&!v[U]);v[q]=!V});const M=[],R=[];g.forEach((L,q)=>{L.type!=="break"&&(M.push(q),R.push(L.time))});const{index:D}=h?Wg(R,w):{index:-1},j=D===-1?-1:M[D],Y=h?g.findIndex(L=>L.type!=="break"&&en(L.time)>w):-1,K=h&&Y===-1&&g.length>0,pt=g.length>0&&v.every(Boolean);let W;return E.jsxs("div",{className:"flex flex-col pb-10",children:[g.length>0&&E.jsx(yh,{collapsed:!pt,children:E.jsxs("div",{className:"flex flex-col items-center gap-1 rounded-2xl border border-gray-200 bg-white px-6 py-10 text-center shadow-sm",children:[E.jsx("p",{className:"text-sm font-medium text-gray-500",children:"That's a wrap for today"}),E.jsx("p",{className:"text-xs text-gray-400",children:"Every event on today's schedule has already happened."})]})}),g.map((L,q)=>{const V=q===j,ot=h&&L.type!=="break"&&!V&&en(L.time)<w;let U=null;!v[q]&&L.type==="session"&&L.sessionNumber!==void 0&&L.sessionNumber!==W&&(W=L.sessionNumber,U=E.jsxs("div",{className:"mt-5 mb-1 text-xs font-bold uppercase tracking-widest text-gray-400",children:["Session ",L.sessionNumber]}));const H=L.type==="break"?E.jsxs("div",{className:"flex items-center gap-2 py-1",children:[E.jsx("div",{className:"h-px flex-1 bg-gray-200"}),E.jsx("span",{className:"text-xs text-gray-400 italic",children:L.label}),E.jsx("div",{className:"h-px flex-1 bg-gray-200"})]}):L.type==="session"?E.jsx(e1,{event:L,runGroups:f,past:ot}):E.jsx(n1,{event:L,past:ot});return E.jsxs(yh,{collapsed:v[q],children:[q===Y&&E.jsx(Wo,{ref:d,events:g}),U,H]},q)}),K&&E.jsx(Wo,{ref:d,events:g})]})}function a1({groups:r,selected:f,onChange:h}){const[c,s]=vt.useState(!1),d=g=>h(f.includes(g)?f.filter(v=>v!==g):[...f,g]),S=f.length===0||f.length===r.length,w=r.filter(g=>f.includes(g.id));return E.jsxs("div",{className:"relative",children:[E.jsxs("button",{onClick:()=>s(g=>!g),className:"flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-3 py-1.5 text-sm shadow-sm transition-colors hover:border-gray-400",children:[S?E.jsx("span",{className:"text-gray-700",children:"All run groups"}):E.jsx("div",{className:"flex items-center gap-1",children:w.map(g=>E.jsx(tu,{group:g,size:"sm"},g.id))}),E.jsx($h,{size:14,className:"text-gray-400"})]}),c&&E.jsxs(E.Fragment,{children:[E.jsx("div",{className:"fixed inset-0 z-10",onClick:()=>s(!1)}),E.jsxs("div",{className:"absolute left-0 top-full z-20 mt-1 min-w-[180px] rounded-xl border border-gray-200 bg-white p-1 shadow-xl",children:[r.map(g=>E.jsxs("button",{onClick:()=>d(g.id),className:"flex w-full items-center justify-between rounded-lg px-3 py-2 hover:bg-gray-50",children:[E.jsx(tu,{group:g,size:"md"}),f.includes(g.id)&&E.jsx(eu,{size:14,className:"text-blue-500"})]},g.id)),E.jsx("div",{className:"mt-1 border-t border-gray-100 pt-1",children:E.jsx("button",{onClick:()=>{h([]),s(!1)},className:"w-full rounded-lg px-3 py-2 text-left text-sm text-gray-400 hover:bg-gray-50",children:S?"All selected":"Clear filter"})})]})]})]})}function ph(r){const f=za();return r.days.some(h=>h.date===f)}function vh(){return E.jsxs("span",{className:"inline-flex shrink-0 items-center gap-1 rounded-full bg-red-100 px-1.5 py-px text-[9px] font-semibold uppercase tracking-wide text-red-700",children:[E.jsx("span",{className:"h-1 w-1 rounded-full bg-red-700 animate-pulse"}),"Live"]})}function i1({events:r,active:f,onChange:h}){const[c,s]=vt.useState(!1);return E.jsxs("div",{className:"relative min-w-0 pl-1",children:[E.jsxs("div",{className:"flex items-center gap-1",children:[E.jsxs("button",{onClick:()=>s(d=>!d),className:"flex items-center gap-1 text-left group min-w-0",children:[E.jsx("h1",{className:"text-xl font-bold text-gray-900 leading-tight",children:f.name}),ph(f)&&E.jsx(vh,{}),E.jsx($h,{size:16,className:"shrink-0 text-gray-400 group-hover:text-gray-600 transition-colors"})]}),f.link&&E.jsx("a",{href:f.link,target:"_blank",rel:"noopener noreferrer","aria-label":"Event page",className:"shrink-0 rounded-md p-1 text-gray-400 transition-colors hover:text-gray-700",children:E.jsx(Zg,{size:14})})]}),E.jsx("p",{className:"text-sm text-gray-500",children:f.subtitle}),c&&E.jsxs(E.Fragment,{children:[E.jsx("div",{className:"fixed inset-0 z-10",onClick:()=>s(!1)}),E.jsx("div",{className:"absolute left-0 top-full z-20 mt-2 min-w-[200px] rounded-xl border border-gray-200 bg-white p-1 shadow-xl",children:r.map(d=>E.jsxs("button",{onClick:()=>{h(d),s(!1)},className:"flex w-full items-center justify-between rounded-lg px-4 py-2.5 hover:bg-gray-50 text-left",children:[E.jsxs("div",{children:[E.jsxs("div",{className:"flex items-center gap-1.5",children:[E.jsx("span",{className:"text-sm font-semibold text-gray-900",children:d.name}),ph(d)&&E.jsx(vh,{})]}),E.jsx("div",{className:"text-xs text-gray-400",children:d.subtitle})]}),d.id===f.id&&E.jsx(eu,{size:14,className:"text-blue-500 ml-3 shrink-0"})]},d.id))})]})]})}function u1({checked:r,onChange:f,label:h}){return E.jsxs("label",{style:{display:"flex",alignItems:"center",gap:"8px",cursor:"pointer",userSelect:"none"},children:[h&&E.jsx("span",{style:{fontSize:"14px",color:"#4b5563"},children:h}),E.jsx("button",{type:"button",role:"switch","aria-checked":r,onClick:f,style:{position:"relative",display:"inline-block",width:"44px",height:"24px",borderRadius:"12px",backgroundColor:r?"#000000":"#d1d5db",border:"none",cursor:"pointer",padding:0,flexShrink:0,transition:"background-color 0.2s ease",WebkitTapHighlightColor:"transparent"},children:E.jsx("span",{style:{position:"absolute",top:"2px",left:r?"22px":"2px",width:"20px",height:"20px",borderRadius:"50%",backgroundColor:"white",boxShadow:"0 1px 4px rgba(0,0,0,0.25)",transition:"left 0.2s ease",display:"block"}})})]})}const Jn=72,c1=110;function o1({children:r}){const[f,h]=vt.useState(0),[c,s]=vt.useState("idle"),d=vt.useRef(null),S=vt.useRef(0);vt.useEffect(()=>{const M=j=>{window.scrollY===0&&(d.current=j.touches[0].clientY)},R=j=>{if(d.current===null)return;const Y=j.touches[0].clientY-d.current;if(Y<=0){d.current=null;return}j.preventDefault();const K=Y<Jn?Y:Jn+(Y-Jn)*.25;S.current=Math.min(K,c1),h(S.current),s("pulling")},D=()=>{d.current!==null&&(d.current=null,S.current>=Jn?(s("refreshing"),h(Jn*.75),setTimeout(()=>window.location.reload(),600)):(s("releasing"),h(0),S.current=0,setTimeout(()=>s("idle"),250)))};return document.addEventListener("touchstart",M,{passive:!0}),document.addEventListener("touchmove",R,{passive:!1}),document.addEventListener("touchend",D),document.addEventListener("touchcancel",D),()=>{document.removeEventListener("touchstart",M),document.removeEventListener("touchmove",R),document.removeEventListener("touchend",D),document.removeEventListener("touchcancel",D)}},[]);const w=c==="releasing"||c==="refreshing",g=Math.min(f/Jn,1),v=f>=Jn;return E.jsxs(E.Fragment,{children:[E.jsx("div",{className:"pointer-events-none fixed inset-x-0 z-50 flex justify-center",style:{top:-44,transform:`translateY(${f}px)`,transition:w?"transform 0.25s ease":"none"},children:E.jsx("div",{className:`flex h-8 w-8 items-center justify-center rounded-full bg-white shadow-md ${v?"text-blue-500":"text-gray-400"}`,children:E.jsx(Jg,{size:16,className:c==="refreshing"?"animate-spin":"",style:c!=="refreshing"?{transform:`rotate(${g*270}deg)`}:void 0})})}),E.jsx("div",{style:{transform:`translateY(${f}px)`,transition:w?"transform 0.25s ease":"none"},children:r})]})}function r1({groups:r}){const f=r.filter(h=>h.description);return f.length===0?null:E.jsxs("div",{className:"mt-2 rounded-2xl border border-gray-200 bg-white p-4 shadow-sm",children:[E.jsx("div",{className:"mb-2 text-xs font-bold uppercase tracking-widest text-gray-400",children:"Legend"}),E.jsx("ul",{className:"flex flex-col gap-1.5",children:f.map(h=>E.jsxs("li",{className:"flex items-center gap-2 text-sm text-gray-700",children:[E.jsx("span",{className:`h-3 w-3 shrink-0 rounded-full ${h.bgClass}`,"aria-hidden":"true"}),E.jsx("span",{className:"font-medium text-gray-900",children:h.label}),E.jsx("span",{className:"text-gray-400",children:"·"}),E.jsx("span",{children:h.description})]},h.id))})]})}const bh=`// HPDE track-day schedule — iOS Home Screen widget for Scriptable.
...
`,j1="/hpde/pr-preview/pr-125/assets/msrc-1-7-D9G0r_nf.jpg",L1={...Da("2026-09-11_msrc-1-7",H1),mapImage:j1},q1=`# TXR SCCA
...
`,G1=Da("2026-09-13_msr-scca",q1),k1=`# MSRC 1.7 Fast Track
...
`,Y1=Da("2026-06-06_msrc-1-7",k1),Q1=`# MSRC 3.1
...
`,V1=Da("2025-11-07_msrc-3-1",Q1),X1=`# ECR 2.7
...
`,Z1=Da("2026-05-30_ecr-2-7",X1),K1=za(),J1={id:"test-live",name:"Test Event",subtitle:"Test data, not a real event",runGroups:[{id:"red",label:"Red",bgClass:"bg-runred-500",textClass:"text-white",description:"Time Trial"},{id:"green",label:"Green",bgClass:"bg-rungreen-500",textClass:"text-white",description:"Track Day"}],days:[{id:"today",label:"Today",date:K1,events:[{time:"07:00",type:"general",label:"Gates open"},{time:"08:00",type:"general",label:"Registration / check-in opens"},{time:"08:30",type:"general",label:"Instructor’s meeting",subtitle:"In clubhouse"},{time:"09:00",type:"session",sessionNumber:1,onTrack:["red"]},{time:"09:20",type:"session",sessionNumber:1,onTrack:["green"]},{time:"12:00",type:"lunch",label:"Lunch break"},{time:"13:00",type:"session",sessionNumber:2,onTrack:["red"]},{time:"13:20",type:"session",sessionNumber:2,onTrack:["green"]},{time:"17:00",type:"general",label:"Gates close"}]}]},Pi=[L1,G1,Y1,Z1,V1].sort((r,f)=>f.id.localeCompare(r.id)),Jh=[...Pi,J1];function $i(r,f){const[h,c]=vt.useState(()=>{try{const s=localStorage.getItem(r);return s!==null?JSON.parse(s):f}catch{return f}});return vt.useEffect(()=>{localStorage.setItem(r,JSON.stringify(h))},[r,h]),[h,c]}function c0(r){const f=za();return r.days.find(h=>h.date===f)}function Fh(r){return c0(r)??r.days[0]}function F1(){const[r,f]=vt.useState(()=>window.location.hash);vt.useEffect(()=>{const c=()=>{f(window.location.hash),window.scrollTo(0,0)};return window.addEventListener("hashchange",c),()=>window.removeEventListener("hashchange",c)},[]);function h(c){window.location.hash!==c&&(window.location.hash=c)}return[r,h]}const $o="#/event/";function Ih(r){return`${$o}${encodeURIComponent(r)}`}function I1(r){return r.startsWith($o)?decodeURIComponent(r.slice($o.length)):null}function W1(){const[r,f]=F1(),[h,c]=vt.useState("schedule"),[s,d]=$i("hpde:activeEvent",Pi[0].id),[S,w]=$i("hpde:activeDay",null),[g,v]=$i("hpde:groups",[]),[M,R]=$i("hpde:hidePast",!1),D=Jh.find(U=>U.id===s)??Pi[0],j=D.days.find(U=>U.id===S)??Fh(D),Y=c0(D),K=j.date===za(),pt=D.days.length>1,L=D.days.reduce((U,H)=>H.date>U?H.date:U,D.days[0].date)<za(),[,q]=vt.useState(0);vt.useEffect(()=>{if(!K)return;const U=setInterval(()=>q(H=>H+1),6e4);return()=>clearInterval(U)},[K]);const V=K&&j.events.some(U=>U.type!=="break"&&en(U.time)<tr());function ot(U){d(U.id),w(Fh(U).id),v([]),f(Ih(U.id))}return vt.useEffect(()=>{const U=I1(r);if(U){const H=Jh.find(X=>X.id===U);H&&H.id!==s&&ot(H);return}(r===""||r==="#")&&f(Ih(s))},[r]),r==="#/widget-script"?E.jsx(s1,{}):r==="#/share"?E.jsx(B1,{}):E.jsx(o1,{children:E.jsxs("div",{className:"min-h-screen bg-gray-50",children:[E.jsxs("div",{className:"mx-auto max-w-lg px-3 py-4 sm:px-4 sm:py-6",children:[E.jsxs("div",{className:"mb-4 flex items-start justify-between gap-3",children:[E.jsx(i1,{events:Pi,active:D,onChange:ot}),E.jsxs("div",{className:"flex gap-1 rounded-lg bg-gray-100 p-1 shrink-0 self-start",children:[E.jsx("button",{onClick:()=>c("schedule"),className:`rounded-md p-2 transition-colors ${h==="schedule"?"bg-white text-gray-900 shadow-sm":"text-gray-400 hover:text-gray-600"}`,style:{minWidth:36,minHeight:36},children:E.jsx(Xg,{size:18})}),E.jsx("button",{onClick:()=>c("map"),className:`rounded-md p-2 transition-colors ${h==="map"?"bg-white text-gray-900 shadow-sm":"text-gray-400 hover:text-gray-600"}`,style:{minWidth:36,minHeight:36},children:E.jsx(mh,{size:18})})]})]}),L&&E.jsx("div",{className:"mb-4 rounded-lg border border-gray-200 bg-gray-100 px-3 py-2 text-center text-sm text-gray-600",children:"This event has passed."}),h==="schedule"&&E.jsxs(E.Fragment,{children:[pt&&E.jsxs("div",{className:"mb-3 flex items-center gap-2",children:[E.jsx("div",{className:"flex flex-1 gap-1 rounded-lg bg-white border border-gray-200 p-1 shadow-sm min-w-0",children:D.days.map(U=>E.jsx("button",{onClick:()=>w(U.id),className:`flex-1 rounded-md py-2 text-sm font-medium capitalize transition-colors ${j.id===U.id?"bg-gray-900 text-white":"text-gray-500 hover:text-gray-800"}`,children:U.label},U.id))}),E.jsx("button",{onClick:()=>Y&&w(Y.id),disabled:K||!Y,className:`rounded-lg border px-3 py-2 text-sm font-medium transition-colors shrink-0 ${K||!Y?"border-gray-100 bg-white text-gray-300 cursor-default":"border-gray-200 bg-white text-gray-700 shadow-sm hover:border-gray-400"}`,children:"Now"})]}),E.jsxs("div",{className:"mb-4 flex items-center justify-between gap-3",children:[E.jsx(a1,{groups:D.runGroups,selected:g,onChange:v}),V&&E.jsx(u1,{checked:M,onChange:()=>R(U=>!U),label:"Hide past events"})]}),E.jsx(l1,{events:j.events,runGroups:D.runGroups,isToday:K,selectedGroups:g,hidePast:M}),E.jsx(r1,{groups:D.runGroups})]}),h==="map"&&(D.mapImage?E.jsx("div",{className:"overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm",children:E.jsx("img",{src:D.mapImage,alt:`${D.name} track map`,className:"block w-full h-auto"})}):E.jsx("div",{className:"flex aspect-[4/3] items-center justify-center rounded-2xl border border-gray-200 bg-white text-gray-400 shadow-sm",children:E.jsxs("div",{className:"text-center",children:[E.jsx(mh,{size:40,className:"mx-auto mb-2 opacity-30"}),E.jsx("p",{className:"text-sm",children:"Track map coming soon"})]})}))]}),E.jsxs("div",{className:"mt-6 pb-8 text-center text-xs",children:[E.jsxs("div",{children:[E.jsx("a",{href:"#/widget-script",className:"text-gray-600 underline hover:text-gray-800",children:"iOS widget"})," · ",E.jsx("a",{href:"#/share",className:"text-gray-600 underline hover:text-gray-800",children:"Share"})]}),E.jsxs("div",{className:"mt-4 font-mono text-[10px] text-gray-300",children:["build ",t1("2026-09-16T16:59:17-05:00")]})]})]})})}kg.createRoot(document.getElementById("root")).render(E.jsx(vt.StrictMode,{children:E.jsx(W1,{})}));
