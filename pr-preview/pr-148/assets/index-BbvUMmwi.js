 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const $g=vt.forwardRef(({color:r="currentColor",size:f=24,strokeWidth:h=2,absoluteStrokeWidth:c,className:s="",children:d,iconNode:S,...E},m)=>vt.createElement("svg",{ref:m,...Wg,width:f,height:f,stroke:r,strokeWidth:c?Number(h)*24/Number(f):h,className:l0("lucide",s),...E},[...S.map(([v,O])=>vt.createElement(v,O)),...Array.isArray(d)?d:[d]]));/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const $t=(r,f)=>{const h=vt.forwardRef(({className:c,...s},d)=>vt.createElement($g,{ref:d,iconNode:f,className:l0(`lucide-${Ig(r)}`,c),...s}));return h.displayName=`${r}`,h};/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
`,lo="/hpde/pr-preview/pr-148/assets/msrc-1-7-D9G0r_nf.jpg",lp={...Ua("2026-09-11_msrc-1-7",ap),mapImage:lo},ip=`# SCCA at MSRC 1.7 CW
...
`,up={...Ua("2026-09-13_msr-scca",ip),mapImage:lo},cp=`# TDE at MSRC 1.7 Fast Track
...
`,rp={...Ua("2026-06-06_msrc-1-7",cp),mapImage:lo},op=`# TDE at MSRC 3.1
...
`,sp="/hpde/pr-preview/pr-148/assets/msrc-3-1-BsOP6CK2.png",fp={...Ua("2025-11-07_msrc-3-1",op),mapImage:sp},dp=`# TDE at ECR 2.7
...
`,hp="/hpde/pr-preview/pr-148/assets/ecr-BW_3Ndfh.png",mp={...Ua("2026-05-30_ecr-2-7",dp),mapImage:hp},gp=`# Test Event
...
`,t0=Ua("test-live",gp),pp={...t0,days:t0.days.map(r=>({...r,date:kl()}))},eu=[lp,up,rp,mp,fp].sort((r,f)=>f.id.localeCompare(r.id)),e0=[...eu,pp];function tu(r,f){const[h,c]=vt.useState(()=>{try{const s=localStorage.getItem(r);return s!==null?JSON.parse(s):f}catch{return f}});return vt.useEffect(()=>{localStorage.setItem(r,JSON.stringify(h))},[r,h]),[h,c]}function g0(r){const f=kl();return r.days.find(h=>h.date===f)}function n0(r){return g0(r)??r.days[0]}function yp(){const[r,f]=vt.useState(()=>window.location.hash);vt.useEffect(()=>{const c=()=>{f(window.location.hash),window.scrollTo(0,0)};return window.addEventListener("hashchange",c),()=>window.removeEventListener("hashchange",c)},[]);function h(c){window.location.hash!==c&&(window.location.hash=c)}return[r,h]}const Pr="#/event/";function a0(r){return`${Pr}${encodeURIComponent(r)}`}function vp(r){return r.startsWith(Pr)?decodeURIComponent(r.slice(Pr.length)):null}function bp(){const[r,f]=yp(),[h,c]=vt.useState("schedule"),[s,d]=tu("hpde:activeEvent",eu[0].id),[S,E]=tu("hpde:activeDay",null),[m,v]=tu("hpde:groups",[]),[O,D]=tu("hpde:hidePast",!1),[k,B]=vt.useState(!1),L=e0.find(U=>U.id===s)??eu[0],Z=L.days.find(U=>U.id===S)??n0(L),I=g0(L),q=Z.date===kl(),H=L.days.length>1,K=L.days.reduce((U,X)=>X.date>U?X.date:U,L.days[0].date)<kl(),[,st]=vt.useState(0);vt.useEffect(()=>{if(!q)return;const U=setInterval(()=>st(X=>X+1),6e4);return()=>clearInterval(U)},[q]);const Q=q&&Z.activities.some(U=>U.type!=="break"&&en(U.time)<no());function j(U){d(U.id),E(n0(U).id),v([]),f(a0(U.id))}return vt.useEffect(()=>{const U=vp(r);if(U){const X=e0.find(nt=>nt.id===U);X&&X.id!==s&&j(X);return}(r===""||r==="#")&&f(a0(s))},[r]),r==="#/widget-script"?p.jsx(A1,{}):r==="#/share"?p.jsx(F1,{}):p.jsxs(p.Fragment,{children:[p.jsx(T1,{children:p.jsxs("div",{className:"min-h-screen bg-gray-50",children:[p.jsxs("div",{className:"mx-auto max-w-lg px-3 py-4 sm:px-4 sm:py-6",children:[p.jsxs("div",{className:"mb-4 flex items-start justify-between gap-3",children:[p.jsx(S1,{events:eu,active:L,onChange:j,onOpenDetails:()=>B(!0)}),p.jsxs("div",{className:"flex gap-1 rounded-lg bg-gray-100 p-1 shrink-0 self-start",children:[p.jsx("button",{onClick:()=>c("schedule"),className:`rounded-md p-2 transition-colors ${h==="schedule"?"bg-white text-gray-900 shadow-sm":"text-gray-400 hover:text-gray-600"}`,style:{minWidth:36,minHeight:36},children:p.jsx(i0,{size:18})}),p.jsx("button",{onClick:()=>c("map"),className:`rounded-md p-2 transition-colors ${h==="map"?"bg-white text-gray-900 shadow-sm":"text-gray-400 hover:text-gray-600"}`,style:{minWidth:36,minHeight:36},children:p.jsx(vh,{size:18})})]})]}),K&&p.jsx("div",{className:"mb-4 rounded-lg border border-gray-200 bg-gray-100 px-3 py-2 text-center text-sm text-gray-600",children:"This event has passed."}),h==="schedule"&&p.jsxs(p.Fragment,{children:[H&&p.jsxs("div",{className:"mb-3 flex items-center gap-2",children:[p.jsx("div",{className:"flex flex-1 gap-1 rounded-lg bg-white border border-gray-200 p-1 shadow-sm min-w-0",children:L.days.map(U=>p.jsx("button",{onClick:()=>E(U.id),className:`flex-1 rounded-md py-2 text-sm font-medium capitalize transition-colors ${Z.id===U.id?"bg-gray-900 text-white":"text-gray-500 hover:text-gray-800"}`,children:U.label},U.id))}),p.jsx("button",{onClick:()=>I&&E(I.id),disabled:q||!I,className:`rounded-lg border px-3 py-2 text-sm font-medium transition-colors shrink-0 ${q||!I?"border-gray-100 bg-white text-gray-300 cursor-default":"border-gray-200 bg-white text-gray-700 shadow-sm hover:border-gray-400"}`,children:"Now"})]}),p.jsxs("div",{className:"mb-4 flex items-center justify-between gap-3",children:[p.jsx(b1,{groups:L.runGroups,selected:m,onChange:v}),Q&&p.jsx(w1,{checked:O,onChange:()=>D(U=>!U),label:"Hide past activities"})]}),p.jsx(v1,{activities:Z.activities,runGroups:L.runGroups,isToday:q,selectedGroups:m,hidePast:O}),p.jsx(x1,{groups:L.runGroups})]}),h==="map"&&(L.mapImage?p.jsx("div",{className:"overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm",children:p.jsx("img",{src:L.mapImage,alt:`${L.name} track map`,className:"block w-full h-auto"})}):p.jsx("div",{className:"flex aspect-[4/3] items-center justify-center rounded-2xl border border-gray-200 bg-white text-gray-400 shadow-sm",children:p.jsxs("div",{className:"text-center",children:[p.jsx(vh,{size:40,className:"mx-auto mb-2 opacity-30"}),p.jsx("p",{className:"text-sm",children:"Track map coming soon"})]})}))]}),p.jsxs("div",{className:"mt-6 pb-8 text-center text-xs",children:[p.jsxs("div",{children:[p.jsx("a",{href:"#/widget-script",className:"text-gray-600 underline hover:text-gray-800",children:"iOS widget"})," · ",p.jsx("a",{href:"#/share",className:"text-gray-600 underline hover:text-gray-800",children:"Share"})]}),p.jsxs("div",{className:"mt-4 font-mono text-[10px] text-gray-300",children:["build ",g1("2026-09-17T20:23:35-05:00")]})]})]})}),p.jsx(ep,{event:L,open:k,onClose:()=>B(!1)})]})}Fg.createRoot(document.getElementById("root")).render(p.jsx(vt.StrictMode,{children:p.jsx(bp,{})}));
