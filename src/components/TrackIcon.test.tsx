...
describe('TrackIcon', () => {
  ...
  it.each([undefined, 'no-such-track'])('falls back to the checkered flag in the placeholder tone (trackId %s)', trackId => {
    ...
    expect(glyph(container)).toHaveClass('text-gray-500')
