 ...
 */var ch;function Ug(){if(ch)return zl;ch=1;var r=Symbol.for("react.transitional.element"),f=Symbol.for("react.fragment");function h(c,s,d){var b=null;if(d!==void 0&&(b=""+d),s.key!==void 0&&(b=""+s.key),"key"in s){d={};for(var E in s)E!=="key"&&(d[E]=s[E])}else d=s;return s=d.ref,{$$typeof:r,type:c,key:b,ref:s!==void 0?s:null,props:d}}return zl.Fragment=f,zl.jsx=h,zl.jsxs=h,zl}var rh;function jg(){return rh||(rh=1,Er.exports=Ug()),Er.exports}var v=jg(),Tr={exports:{}},ct={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var fh;function qg(){return fh||(fh=1,(function(r){function f(N,Z){var at=N.length;N.push(Z);t:for(;0<at;){var Tt=at-1>>>1,wt=N[Tt];if(0<s(wt,Z))N[Tt]=Z,N[at]=wt,at=Tt;else break t}}function h(N){return N.length===0?null:N[0]}function c(N){if(N.length===0)return null;var Z=N[0],at=N.pop();if(at!==Z){N[0]=at;t:for(var Tt=0,wt=N.length,y=wt>>>1;Tt<y;){var z=2*(Tt+1)-1,Q=N[z],F=z+1,ut=N[F];if(0>s(Q,at))F<wt&&0>s(ut,Q)?(N[Tt]=ut,N[F]=at,Tt=F):(N[Tt]=Q,N[z]=at,Tt=z);else if(F<wt&&0>s(ut,at))N[Tt]=ut,N[F]=at,Tt=F;else break t}}return Z}function s(N,Z){var at=N.sortIndex-Z.sortIndex;return at!==0?at:N.id-Z.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var d=performance;r.unstable_now=function(){return d.now()}}else{var b=Date,E=b.now();r.unstable_now=function(){return b.now()-E}}var g=[],S=[],O=1,D=null,k=3,B=!1,L=!1,j=!1,nt=!1,G=typeof setTimeout=="function"?setTimeout:null,q=typeof clearTimeout=="function"?clearTimeout:null,Y=typeof setImmediate<"u"?setImmediate:null;function K(N){for(var Z=h(S);Z!==null;){if(Z.callback===null)c(S);else if(Z.startTime<=N)c(S),Z.sortIndex=Z.expirationTime,f(g,Z);else break;Z=h(S)}}function st(N){if(j=!1,K(N),!L)if(h(g)!==null)L=!0,V||(V=!0,I());else{var Z=h(S);Z!==null&&Lt(st,Z.startTime-N)}}var V=!1,U=-1,H=5,X=-1;function et(){return nt?!0:!(r.unstable_now()-X<H)}function $(){if(nt=!1,V){var N=r.unstable_now();X=N;var Z=!0;try{t:{L=!1,j&&(j=!1,q(U),U=-1),B=!0;var at=k;try{e:{for(K(N),D=h(g);D!==null&&!(D.expirationTime>N&&et());){var Tt=D.callback;if(typeof Tt=="function"){D.callback=null,k=D.priorityLevel;var wt=Tt(D.expirationTime<=N);if(N=r.unstable_now(),typeof wt=="function"){D.callback=wt,K(N),Z=!0;break e}D===h(g)&&c(g),K(N)}else c(g);D=h(g)}if(D!==null)Z=!0;else{var y=h(S);y!==null&&Lt(st,y.startTime-N),Z=!1}}break t}finally{D=null,k=at,B=!1}Z=void 0}}finally{Z?I():V=!1}}}var I;if(typeof Y=="function")I=function(){Y($)};else if(typeof MessageChannel<"u"){var P=new MessageChannel,it=P.port2;P.port1.onmessage=$,I=function(){it.postMessage(null)}}else I=function(){G($,0)};function Lt(N,Z){U=G(function(){N(r.unstable_now())},Z)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(N){N.callback=null},r.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):H=0<N?Math.floor(1e3/N):5},r.unstable_getCurrentPriorityLevel=function(){return k},r.unstable_next=function(N){switch(k){case 1:case 2:case 3:var Z=3;break;default:Z=k}var at=k;k=Z;try{return N()}finally{k=at}},r.unstable_requestPaint=function(){nt=!0},r.unstable_runWithPriority=function(N,Z){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var at=k;k=N;try{return Z()}finally{k=at}},r.unstable_scheduleCallback=function(N,Z,at){var Tt=r.unstable_now();switch(typeof at=="object"&&at!==null?(at=at.delay,at=typeof at=="number"&&0<at?Tt+at:Tt):at=Tt,N){case 1:var wt=-1;break;case 2:wt=250;break;case 5:wt=1073741823;break;case 4:wt=1e4;break;default:wt=5e3}return wt=at+wt,N={id:O++,callback:Z,priorityLevel:N,startTime:at,expirationTime:wt,sortIndex:-1},at>Tt?(N.sortIndex=at,f(S,N),h(g)===null&&N===h(S)&&(j?(q(U),U=-1):j=!0,Lt(st,at-Tt))):(N.sortIndex=wt,f(g,N),L||B||(L=!0,V||(V=!0,I()))),N},r.unstable_shouldYield=et,r.unstable_wrapCallback=function(N){var Z=k;return function(){var at=k;k=Z;try{return N.apply(this,arguments)}finally{k=at}}}})(Cr)),Cr}var dh;function Yg(){return dh||(dh=1,Ar.exports=qg()),Ar.exports}var Nr={exports:{}},$t={};/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Fg=vt.forwardRef(({color:r="currentColor",size:f=24,strokeWidth:h=2,absoluteStrokeWidth:c,className:s="",children:d,iconNode:b,...E},g)=>vt.createElement("svg",{ref:g,...Jg,width:f,height:f,stroke:r,strokeWidth:c?Number(h)*24/Number(f):h,className:n0("lucide",s),...E},[...b.map(([S,O])=>vt.createElement(S,O)),...Array.isArray(d)?d:[d]]));/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ne=(r,f)=>{const h=vt.forwardRef(({className:c,...s},d)=>vt.createElement(Fg,{ref:d,iconNode:f,className:n0(`lucide-${Kg(r)}`,c),...s}));return h.displayName=`${r}`,h};/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
`,J1="/hpde/assets/msrc-1-7-D9G0r_nf.jpg",F1={...ja("2026-09-11_msrc-1-7",K1),mapImage:J1},I1=`# TXR SCCA
