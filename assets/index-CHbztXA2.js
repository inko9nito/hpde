 ...
 */var hh;function $0(){if(hh)return Rl;hh=1;var r=Symbol.for("react.transitional.element"),c=Symbol.for("react.fragment");function f(s,d,h){var v=null;if(h!==void 0&&(v=""+h),d.key!==void 0&&(v=""+d.key),"key"in d){h={};for(var S in d)S!=="key"&&(h[S]=d[S])}else h=d;return d=h.ref,{$$typeof:r,type:s,key:v,ref:d!==void 0?d:null,props:h}}return Rl.Fragment=c,Rl.jsx=f,Rl.jsxs=f,Rl}var gh;function P0(){return gh||(gh=1,Er.exports=$0()),Er.exports}var g=P0(),Nr={exports:{}},re={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var mh;function ep(){if(mh)return re;mh=1;var r=Symbol.for("react.transitional.element"),c=Symbol.for("react.portal"),f=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),d=Symbol.for("react.profiler"),h=Symbol.for("react.consumer"),v=Symbol.for("react.context"),S=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),y=Symbol.for("react.memo"),k=Symbol.for("react.lazy"),R=Symbol.for("react.activity"),H=Symbol.iterator;function L(w){return w===null||typeof w!="object"?null:(w=H&&w[H]||w["@@iterator"],typeof w=="function"?w:null)}var q={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},K=Object.assign,ie={};function U(w,z,X){this.props=w,this.context=z,this.refs=ie,this.updater=X||q}U.prototype.isReactComponent={},U.prototype.setState=function(w,z){if(typeof w!="object"&&typeof w!="function"&&w!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,w,z,"setState")},U.prototype.forceUpdate=function(w){this.updater.enqueueForceUpdate(this,w,"forceUpdate")};function j(){}j.prototype=U.prototype;function M(w,z,X){this.props=w,this.context=z,this.refs=ie,this.updater=X||q}var Y=M.prototype=new j;Y.constructor=M,K(Y,U.prototype),Y.isPureReactComponent=!0;var oe=Array.isArray;function V(){}var B={H:null,A:null,T:null,S:null},J=Object.prototype.hasOwnProperty;function Q(w,z,X){var W=X.ref;return{$$typeof:r,type:w,key:z,ref:W!==void 0?W:null,props:X}}function ee(w,z){return Q(w.type,z,w.props)}function $(w){return typeof w=="object"&&w!==null&&w.$$typeof===r}function G(w){var z={"=":"=0",":":"=2"};return"$"+w.replace(/[=:]/g,function(X){return z[X]})}var Z=/\/+/g;function ne(w,z){return typeof w=="object"&&w!==null&&w.key!=null?G(""+w.key):z.toString(36)}function Be(w){switch(w.status){case"fulfilled":return w.value;case"rejected":throw w.reason;default:switch(typeof w.status=="string"?w.then(V,V):(w.status="pending",w.then(function(z){w.status==="pending"&&(w.status="fulfilled",w.value=z)},function(z){w.status==="pending"&&(w.status="rejected",w.reason=z)})),w.status){case"fulfilled":return w.value;case"rejected":throw w.reason}}throw w}function A(w,z,X,W,se){var fe=typeof w;(fe==="undefined"||fe==="boolean")&&(w=null);var he=!1;if(w===null)he=!0;else switch(fe){case"bigint":case"string":case"number":he=!0;break;case"object":switch(w.$$typeof){case r:case c:he=!0;break;case k:return he=w._init,A(he(w._payload),z,X,W,se)}}if(he)return se=se(w),he=W===""?"."+ne(w,0):W,oe(se)?(X="",he!=null&&(X=he.replace(Z,"$&/")+"/"),A(se,z,X,"",function(jt){return jt})):se!=null&&($(se)&&(se=ee(se,X+(se.key==null||w&&w.key===se.key?"":(""+se.key).replace(Z,"$&/")+"/")+he)),z.push(se)),1;he=0;var ke=W===""?".":W+":";if(oe(w))for(var Ce=0;Ce<w.length;Ce++)W=w[Ce],fe=ke+ne(W,Ce),he+=A(W,z,X,fe,se);else if(Ce=L(w),typeof Ce=="function")for(w=Ce.call(w),Ce=0;!(W=w.next()).done;)W=W.value,fe=ke+ne(W,Ce++),he+=A(W,z,X,fe,se);else if(fe==="object"){if(typeof w.then=="function")return A(Be(w),z,X,W,se);throw z=String(w),Error("Objects are not valid as a React child (found: "+(z==="[object Object]"?"object with keys {"+Object.keys(w).join(", ")+"}":z)+"). If you meant to render a collection of children, use an array instead.")}return he}function I(w,z,X){if(w==null)return w;var W=[],se=0;return A(w,W,"","",function(fe){return z.call(X,fe,se++)}),W}function ae(w){if(w._status===-1){var z=w._result;z=z(),z.then(function(X){(w._status===0||w._status===-1)&&(w._status=1,w._result=X)},function(X){(w._status===0||w._status===-1)&&(w._status=2,w._result=X)}),w._status===-1&&(w._status=0,w._result=z)}if(w._status===1)return w._result.default;throw w._result}var Te=typeof reportError=="function"?reportError:function(w){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var z=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof w=="object"&&w!==null&&typeof w.message=="string"?String(w.message):String(w),error:w});if(!window.dispatchEvent(z))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",w);return}console.error(w)},Se={map:I,forEach:function(w,z,X){I(w,function(){z.apply(this,arguments)},X)},count:function(w){var z=0;return I(w,function(){z++}),z},toArray:function(w){return I(w,function(z){return z})||[]},only:function(w){if(!$(w))throw Error("React.Children.only expected to receive a single React element child.");return w}};return re.Activity=R,re.Children=Se,re.Component=U,re.Fragment=f,re.Profiler=d,re.PureComponent=M,re.StrictMode=s,re.Suspense=m,re.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=B,re.__COMPILER_RUNTIME={__proto__:null,c:function(w){return B.H.useMemoCache(w)}},re.cache=function(w){return function(){return w.apply(null,arguments)}},re.cacheSignal=function(){return null},re.cloneElement=function(w,z,X){if(w==null)throw Error("The argument must be a React element, but you passed "+w+".");var W=K({},w.props),se=w.key;if(z!=null)for(fe in z.key!==void 0&&(se=""+z.key),z)!J.call(z,fe)||fe==="key"||fe==="__self"||fe==="__source"||fe==="ref"&&z.ref===void 0||(W[fe]=z[fe]);var fe=arguments.length-2;if(fe===1)W.children=X;else if(1<fe){for(var he=Array(fe),ke=0;ke<fe;ke++)he[ke]=arguments[ke+2];W.children=he}return Q(w.type,se,W)},re.createContext=function(w){return w={$$typeof:v,_currentValue:w,_currentValue2:w,_threadCount:0,Provider:null,Consumer:null},w.Provider=w,w.Consumer={$$typeof:h,_context:w},w},re.createElement=function(w,z,X){var W,se={},fe=null;if(z!=null)for(W in z.key!==void 0&&(fe=""+z.key),z)J.call(z,W)&&W!=="key"&&W!=="__self"&&W!=="__source"&&(se[W]=z[W]);var he=arguments.length-2;if(he===1)se.children=X;else if(1<he){for(var ke=Array(he),Ce=0;Ce<he;Ce++)ke[Ce]=arguments[Ce+2];se.children=ke}if(w&&w.defaultProps)for(W in he=w.defaultProps,he)se[W]===void 0&&(se[W]=he[W]);return Q(w,fe,se)},re.createRef=function(){return{current:null}},re.forwardRef=function(w){return{$$typeof:S,render:w}},re.isValidElement=$,re.lazy=function(w){return{$$typeof:k,_payload:{_status:-1,_result:w},_init:ae}},re.memo=function(w,z){return{$$typeof:y,type:w,compare:z===void 0?null:z}},re.startTransition=function(w){var z=B.T,X={};B.T=X;try{var W=w(),se=B.S;se!==null&&se(X,W),typeof W=="object"&&W!==null&&typeof W.then=="function"&&W.then(V,Te)}catch(fe){Te(fe)}finally{z!==null&&X.types!==null&&(z.types=X.types),B.T=z}},re.unstable_useCacheRefresh=function(){return B.H.useCacheRefresh()},re.use=function(w){return B.H.use(w)},re.useActionState=function(w,z,X){return B.H.useActionState(w,z,X)},re.useCallback=function(w,z){return B.H.useCallback(w,z)},re.useContext=function(w){return B.H.useContext(w)},re.useDebugValue=function(){},re.useDeferredValue=function(w,z){return B.H.useDeferredValue(w,z)},re.useEffect=function(w,z){return B.H.useEffect(w,z)},re.useEffectEvent=function(w){return B.H.useEffectEvent(w)},re.useId=function(){return B.H.useId()},re.useImperativeHandle=function(w,z,X){return B.H.useImperativeHandle(w,z,X)},re.useInsertionEffect=function(w,z){return B.H.useInsertionEffect(w,z)},re.useLayoutEffect=function(w,z){return B.H.useLayoutEffect(w,z)},re.useMemo=function(w,z){return B.H.useMemo(w,z)},re.useOptimistic=function(w,z){return B.H.useOptimistic(w,z)},re.useReducer=function(w,z,X){return B.H.useReducer(w,z,X)},re.useRef=function(w){return B.H.useRef(w)},re.useState=function(w){return B.H.useState(w)},re.useSyncExternalStore=function(w,z,X){return B.H.useSyncExternalStore(w,z,X)},re.useTransition=function(){return B.H.useTransition()},re.version="19.2.6",re}var ph;function lu(){return ph||(ph=1,Nr.exports=ep()),Nr.exports}var ue=lu(),Cr={exports:{}},Ol={},Ar={exports:{}},_r={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var yh;function tp(){return yh||(yh=1,(function(r){function c(A,I){var ae=A.length;A.push(I);e:for(;0<ae;){var Te=ae-1>>>1,Se=A[Te];if(0<d(Se,I))A[Te]=I,A[ae]=Se,ae=Te;else break e}}function f(A){return A.length===0?null:A[0]}function s(A){if(A.length===0)return null;var I=A[0],ae=A.pop();if(ae!==I){A[0]=ae;e:for(var Te=0,Se=A.length,w=Se>>>1;Te<w;){var z=2*(Te+1)-1,X=A[z],W=z+1,se=A[W];if(0>d(X,ae))W<Se&&0>d(se,X)?(A[Te]=se,A[W]=ae,Te=W):(A[Te]=X,A[z]=ae,Te=z);else if(W<Se&&0>d(se,ae))A[Te]=se,A[W]=ae,Te=W;else break e}}return I}function d(A,I){var ae=A.sortIndex-I.sortIndex;return ae!==0?ae:A.id-I.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var h=performance;r.unstable_now=function(){return h.now()}}else{var v=Date,S=v.now();r.unstable_now=function(){return v.now()-S}}var m=[],y=[],k=1,R=null,H=3,L=!1,q=!1,K=!1,ie=!1,U=typeof setTimeout=="function"?setTimeout:null,j=typeof clearTimeout=="function"?clearTimeout:null,M=typeof setImmediate<"u"?setImmediate:null;function Y(A){for(var I=f(y);I!==null;){if(I.callback===null)s(y);else if(I.startTime<=A)s(y),I.sortIndex=I.expirationTime,c(m,I);else break;I=f(y)}}function oe(A){if(K=!1,Y(A),!q)if(f(m)!==null)q=!0,V||(V=!0,G());else{var I=f(y);I!==null&&Be(oe,I.startTime-A)}}var V=!1,B=-1,J=5,Q=-1;function ee(){return ie?!0:!(r.unstable_now()-Q<J)}function $(){if(ie=!1,V){var A=r.unstable_now();Q=A;var I=!0;try{e:{q=!1,K&&(K=!1,j(B),B=-1),L=!0;var ae=H;try{t:{for(Y(A),R=f(m);R!==null&&!(R.expirationTime>A&&ee());){var Te=R.callback;if(typeof Te=="function"){R.callback=null,H=R.priorityLevel;var Se=Te(R.expirationTime<=A);if(A=r.unstable_now(),typeof Se=="function"){R.callback=Se,Y(A),I=!0;break t}R===f(m)&&s(m),Y(A)}else s(m);R=f(m)}if(R!==null)I=!0;else{var w=f(y);w!==null&&Be(oe,w.startTime-A),I=!1}}break e}finally{R=null,H=ae,L=!1}I=void 0}}finally{I?G():V=!1}}}var G;if(typeof M=="function")G=function(){M($)};else if(typeof MessageChannel<"u"){var Z=new MessageChannel,ne=Z.port2;Z.port1.onmessage=$,G=function(){ne.postMessage(null)}}else G=function(){U($,0)};function Be(A,I){B=U(function(){A(r.unstable_now())},I)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(A){A.callback=null},r.unstable_forceFrameRate=function(A){0>A||125<A?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):J=0<A?Math.floor(1e3/A):5},r.unstable_getCurrentPriorityLevel=function(){return H},r.unstable_next=function(A){switch(H){case 1:case 2:case 3:var I=3;break;default:I=H}var ae=H;H=I;try{return A()}finally{H=ae}},r.unstable_requestPaint=function(){ie=!0},r.unstable_runWithPriority=function(A,I){switch(A){case 1:case 2:case 3:case 4:case 5:break;default:A=3}var ae=H;H=A;try{return I()}finally{H=ae}},r.unstable_scheduleCallback=function(A,I,ae){var Te=r.unstable_now();switch(typeof ae=="object"&&ae!==null?(ae=ae.delay,ae=typeof ae=="number"&&0<ae?Te+ae:Te):ae=Te,A){case 1:var Se=-1;break;case 2:Se=250;break;case 5:Se=1073741823;break;case 4:Se=1e4;break;default:Se=5e3}return Se=ae+Se,A={id:k++,callback:I,priorityLevel:A,startTime:ae,expirationTime:Se,sortIndex:-1},ae>Te?(A.sortIndex=ae,c(y,A),f(m)===null&&A===f(y)&&(K?(j(B),B=-1):K=!0,Be(oe,ae-Te))):(A.sortIndex=Se,c(m,A),q||L||(q=!0,V||(V=!0,G()))),A},r.unstable_shouldYield=ee,r.unstable_wrapCallback=function(A){var I=H;return function(){var ae=H;H=I;try{return A.apply(this,arguments)}finally{H=ae}}}})(_r)),_r}var vh;function np(){return vh||(vh=1,Ar.exports=tp()),Ar.exports}var Mr={exports:{}},Pe={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var bh;function ap(){if(bh)return Pe;bh=1;var r=lu();function c(m){var y="https://react.dev/errors/"+m;if(1<arguments.length){y+="?args[]="+encodeURIComponent(arguments[1]);for(var k=2;k<arguments.length;k++)y+="&args[]="+encodeURIComponent(arguments[k])}return"Minified React error #"+m+"; visit "+y+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function f(){}var s={d:{f,r:function(){throw Error(c(522))},D:f,C:f,L:f,m:f,X:f,S:f,M:f},p:0,findDOMNode:null},d=Symbol.for("react.portal");function h(m,y,k){var R=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:d,key:R==null?null:""+R,children:m,containerInfo:y,implementation:k}}var v=r.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function S(m,y){if(m==="font")return"";if(typeof y=="string")return y==="use-credentials"?y:""}return Pe.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=s,Pe.createPortal=function(m,y){var k=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!y||y.nodeType!==1&&y.nodeType!==9&&y.nodeType!==11)throw Error(c(299));return h(m,y,null,k)},Pe.flushSync=function(m){var y=v.T,k=s.p;try{if(v.T=null,s.p=2,m)return m()}finally{v.T=y,s.p=k,s.d.f()}},Pe.preconnect=function(m,y){typeof m=="string"&&(y?(y=y.crossOrigin,y=typeof y=="string"?y==="use-credentials"?y:"":void 0):y=null,s.d.C(m,y))},Pe.prefetchDNS=function(m){typeof m=="string"&&s.d.D(m)},Pe.preinit=function(m,y){if(typeof m=="string"&&y&&typeof y.as=="string"){var k=y.as,R=S(k,y.crossOrigin),H=typeof y.integrity=="string"?y.integrity:void 0,L=typeof y.fetchPriority=="string"?y.fetchPriority:void 0;k==="style"?s.d.S(m,typeof y.precedence=="string"?y.precedence:void 0,{crossOrigin:R,integrity:H,fetchPriority:L}):k==="script"&&s.d.X(m,{crossOrigin:R,integrity:H,fetchPriority:L,nonce:typeof y.nonce=="string"?y.nonce:void 0})}},Pe.preinitModule=function(m,y){if(typeof m=="string")if(typeof y=="object"&&y!==null){if(y.as==null||y.as==="script"){var k=S(y.as,y.crossOrigin);s.d.M(m,{crossOrigin:k,integrity:typeof y.integrity=="string"?y.integrity:void 0,nonce:typeof y.nonce=="string"?y.nonce:void 0})}}else y==null&&s.d.M(m)},Pe.preload=function(m,y){if(typeof m=="string"&&typeof y=="object"&&y!==null&&typeof y.as=="string"){var k=y.as,R=S(k,y.crossOrigin);s.d.L(m,k,{crossOrigin:R,integrity:typeof y.integrity=="string"?y.integrity:void 0,nonce:typeof y.nonce=="string"?y.nonce:void 0,type:typeof y.type=="string"?y.type:void 0,fetchPriority:typeof y.fetchPriority=="string"?y.fetchPriority:void 0,referrerPolicy:typeof y.referrerPolicy=="string"?y.referrerPolicy:void 0,imageSrcSet:typeof y.imageSrcSet=="string"?y.imageSrcSet:void 0,imageSizes:typeof y.imageSizes=="string"?y.imageSizes:void 0,media:typeof y.media=="string"?y.media:void 0})}},Pe.preloadModule=function(m,y){if(typeof m=="string")if(y){var k=S(y.as,y.crossOrigin);s.d.m(m,{as:typeof y.as=="string"&&y.as!=="script"?y.as:void 0,crossOrigin:k,integrity:typeof y.integrity=="string"?y.integrity:void 0})}else s.d.m(m)},Pe.requestFormReset=function(m){s.d.r(m)},Pe.unstable_batchedUpdates=function(m,y){return m(y)},Pe.useFormState=function(m,y,k){return v.H.useFormState(m,y,k)},Pe.useFormStatus=function(){return v.H.useHostTransitionStatus()},Pe.version="19.2.6",Pe}var wh;function lp(){if(wh)return Mr.exports;wh=1;function r(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(r)}catch(c){console.error(c)}}return r(),Mr.exports=ap(),Mr.exports}/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const cp=ue.forwardRef(({color:r="currentColor",size:c=24,strokeWidth:f=2,absoluteStrokeWidth:s,className:d="",children:h,iconNode:v,...S},m)=>ue.createElement("svg",{ref:m,...up,width:c,height:c,stroke:r,strokeWidth:s?Number(f)*24/Number(c):f,className:fg("lucide",d),...S},[...v.map(([y,k])=>ue.createElement(y,k)),...Array.isArray(h)?h:[h]]));/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Xe=(r,c)=>{const f=ue.forwardRef(({className:s,...d},h)=>ue.createElement(cp,{ref:h,iconNode:c,className:fg(`lucide-${rp(r)}`,s),...d}));return f.displayName=`${r}`,f};/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const dp=Xe("ChevronLeft",[["path",{d:"m15 18-6-6 6-6",key:"1wnfg3"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const gp=Xe("House",[["path",{d:"M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8",key:"5wwlr5"}],["path",{d:"M3 10a2 2 0 0 1 .709-1.528l7-5.999a2 2 0 0 1 2.582 0l7 5.999A2 2 0 0 1 21 10v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z",key:"1d0kgt"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const mp=Xe("Image",[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",ry:"2",key:"1m3agn"}],["circle",{cx:"9",cy:"9",r:"2",key:"af1f0g"}],["path",{d:"m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21",key:"1xmnt7"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const pp=Xe("Link2",[["path",{d:"M9 17H7A5 5 0 0 1 7 7h2",key:"8i5ue5"}],["path",{d:"M15 7h2a5 5 0 1 1 0 10h-2",key:"1b9ql8"}],["line",{x1:"8",x2:"16",y1:"12",y2:"12",key:"1jonct"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const yp=Xe("List",[["path",{d:"M3 12h.01",key:"nlz23k"}],["path",{d:"M3 18h.01",key:"1tta3j"}],["path",{d:"M3 6h.01",key:"1rqtza"}],["path",{d:"M8 12h13",key:"1za7za"}],["path",{d:"M8 18h13",key:"1lx6n3"}],["path",{d:"M8 6h13",key:"ik3vkj"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const vp=Xe("MapPin",[["path",{d:"M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0",key:"1r0f0z"}],["circle",{cx:"12",cy:"10",r:"3",key:"ilqhr7"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const bp=Xe("Map",[["path",{d:"M14.106 5.553a2 2 0 0 0 1.788 0l3.659-1.83A1 1 0 0 1 21 4.619v12.764a1 1 0 0 1-.553.894l-4.553 2.277a2 2 0 0 1-1.788 0l-4.212-2.106a2 2 0 0 0-1.788 0l-3.659 1.83A1 1 0 0 1 3 19.381V6.618a1 1 0 0 1 .553-.894l4.553-2.277a2 2 0 0 1 1.788 0z",key:"169xi5"}],["path",{d:"M15 5.764v15",key:"1pn4in"}],["path",{d:"M9 3.236v15",key:"1uimfh"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const wp=Xe("Maximize2",[["polyline",{points:"15 3 21 3 21 9",key:"mznyad"}],["polyline",{points:"9 21 3 21 3 15",key:"1avn1i"}],["line",{x1:"21",x2:"14",y1:"3",y2:"10",key:"ota7mn"}],["line",{x1:"3",x2:"10",y1:"21",y2:"14",key:"1atl0r"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Sp=Xe("Pizza",[["path",{d:"m12 14-1 1",key:"11onhr"}],["path",{d:"m13.75 18.25-1.25 1.42",key:"1yisr3"}],["path",{d:"M17.775 5.654a15.68 15.68 0 0 0-12.121 12.12",key:"1qtqk6"}],["path",{d:"M18.8 9.3a1 1 0 0 0 2.1 7.7",key:"fbbbr2"}],["path",{d:"M21.964 20.732a1 1 0 0 1-1.232 1.232l-18-5a1 1 0 0 1-.695-1.232A19.68 19.68 0 0 1 15.732 2.037a1 1 0 0 1 1.232.695z",key:"1hyfdd"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const xp=Xe("RefreshCw",[["path",{d:"M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8",key:"v9h5vc"}],["path",{d:"M21 3v5h-5",key:"1q7to0"}],["path",{d:"M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16",key:"3uifl3"}],["path",{d:"M8 16H3v5",key:"1cv678"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Tp=Xe("Route",[["circle",{cx:"6",cy:"19",r:"3",key:"1kj8tv"}],["path",{d:"M9 19h8.5a3.5 3.5 0 0 0 0-7h-11a3.5 3.5 0 0 1 0-7H15",key:"1d8sl"}],["circle",{cx:"18",cy:"5",r:"3",key:"gq8acd"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ep=Xe("Users",[["path",{d:"M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2",key:"1yyitq"}],["circle",{cx:"9",cy:"7",r:"4",key:"nufk8"}],["path",{d:"M22 21v-2a4 4 0 0 0-3-3.87",key:"kshegd"}],["path",{d:"M16 3.13a4 4 0 0 1 0 7.75",key:"1da9ce"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Np=Xe("Utensils",[["path",{d:"M3 2v7c0 1.1.9 2 2 2h4a2 2 0 0 0 2-2V2",key:"cjf0a3"}],["path",{d:"M7 2v20",key:"1473qp"}],["path",{d:"M21 15V2a5 5 0 0 0-5 5v6c0 1.1.9 2 2 2h3Zm0 0v7",key:"j28e5"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const iu=Xe("X",[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]]);function ao({group:r,size:c="md",dim:f}){const s=c==="sm"?"px-2 py-0.5 text-xs":"px-3 py-1 text-sm";return g.jsx("span",{className:`inline-flex items-center rounded-full font-semibold ${r.bgClass} ${r.textClass} ${s} ${f?"opacity-40":""}`,children:r.label})}const Ha=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],Th=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"];function pg(r){if(r.length===0)return"";const c=[...r].sort((k,R)=>k.date.localeCompare(R.date)),f=c[0].date,s=c[c.length-1].date,[d,h,v]=f.split("-").map(Number),[S,m,y]=s.split("-").map(Number);return f===s?`${Ha[h-1]} ${v}, ${d}`:d===S&&h===m?`${Ha[h-1]} ${v}–${y}, ${d}`:d===S?`${Ha[h-1]} ${v} – ${Ha[m-1]} ${y}, ${d}`:`${Ha[h-1]} ${v}, ${d} – ${Ha[m-1]} ${y}, ${S}`}function Cp(r){if(r.length===0)return"";const c=[...r].sort((L,q)=>L.date.localeCompare(q.date)),f=c[0].date,s=c[c.length-1].date,[d,h,v]=f.split("-").map(Number),[S,m,y]=s.split("-").map(Number),k=Th[new Date(d,h-1,v).getDay()],R=pg(r);if(f===s)return`${R} (${k})`;const H=Th[new Date(S,m-1,y).getDay()];return`${R} (${k}–${H})`}function ou(r){return r.subtitle??pg(r.days)}function tn(r){const[c,f]=r.split(":").map(Number);return c*60+f}const Ap=30;function _p(r,c){let f=-1;for(let S=0;S<r.length&&tn(r[S])<=c;S++)f=S;if(f===-1)return{index:-1,progress:0};const s=tn(r[f]),d=r[f+1]?tn(r[f+1]):null,h=d!==null?d:s+Ap;if(c>=h)return{index:-1,progress:0};const v=h===s?0:(c-s)/(h-s);return{index:f,progress:Math.max(0,Math.min(1,v))}}function yg(r){const[c,f]=r.split(":").map(Number);return`${c%12||12}:${f.toString().padStart(2,"0")}`}function vg(r){const[c]=r.split(":").map(Number);return c>=12?"PM":"AM"}function su(){const r=new Date;return r.getHours()*60+r.getMinutes()}function Fn(){const r=new Date,c=r.getFullYear(),f=String(r.getMonth()+1).padStart(2,"0"),s=String(r.getDate()).padStart(2,"0");return`${c}-${f}-${s}`}function Mp(){const r=new Date,c=r.getHours(),f=r.getMinutes(),s=c%12||12,d=c>=12?"PM":"AM";return`${s}:${f.toString().padStart(2,"0")} ${d}`}function Dp(r){if(r<=0)return"";if(r<60)return`${r} min`;const c=Math.floor(r/60),f=r%60;return f===0?`${c}h`:`${c}h ${f}m`}function kp(r){const c=new Date(r);if(isNaN(c.getTime()))return r;const f=c.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"}),s=c.toLocaleTimeString(void 0,{hour:"numeric",minute:"2-digit"});return`${f}, ${s}`}function Eh(r,c){return r.flatMap(f=>{const s=c.find(d=>d.id===f);return s?[s]:[]})}function Rp({activity:r,runGroups:c,past:f}){const s=Eh(r.onTrack,c),d=Eh(r.inClass??[],c);return g.jsx("div",{className:`rounded-xl border border-gray-200 bg-white p-4 shadow-sm transition-opacity ${f?"opacity-60":""}`,children:g.jsxs("div",{className:"flex gap-4",children:[g.jsxs("div",{className:"flex w-20 shrink-0 items-baseline gap-0.5 font-mono text-lg font-semibold text-gray-900",children:[yg(r.time),g.jsx("span",{className:"font-sans text-[10px] font-normal text-gray-400",children:vg(r.time)})]}),g.jsxs("div",{className:"flex flex-1 flex-col gap-3",children:[s.length>0&&g.jsxs("div",{className:"flex items-center gap-3",children:[g.jsx("span",{className:"w-16 shrink-0 text-xs text-gray-900",children:"On track"}),g.jsx("div",{className:"flex flex-wrap gap-1.5",children:s.map(h=>g.jsx(ao,{group:h},h.id))})]}),d.length>0&&g.jsxs(g.Fragment,{children:[s.length>0&&g.jsx("div",{className:"border-t border-gray-100"}),g.jsxs("div",{className:"flex items-center gap-3",children:[g.jsx("span",{className:"w-16 shrink-0 text-xs text-gray-900",children:"In class"}),g.jsx("div",{className:"flex flex-wrap gap-1.5",children:d.map(h=>g.jsx(ao,{group:h},h.id))})]})]}),r.note&&g.jsx("p",{className:"text-xs italic text-gray-500",children:r.note})]})]})})}function Op({activity:r,past:c}){const f=r.type==="lunch"||r.type==="special";return g.jsx("div",{className:`rounded-xl p-4 shadow-sm transition-opacity ${f?"border-2 border-gray-900 bg-white my-2":"border border-gray-200 bg-white"} ${c?"opacity-60":""}`,children:g.jsxs("div",{className:"flex items-center gap-4",children:[g.jsxs("div",{className:"flex w-20 shrink-0 items-baseline gap-0.5 font-mono text-lg font-semibold text-gray-900",children:[yg(r.time),g.jsx("span",{className:"font-sans text-[10px] font-normal text-gray-400",children:vg(r.time)})]}),f&&g.jsx("div",{className:"flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-gray-900 text-white",children:r.type==="lunch"?g.jsx(Np,{size:16}):g.jsx(Sp,{size:16})}),g.jsxs("div",{children:[g.jsx("p",{className:"text-sm font-medium text-gray-900",children:r.label}),r.subtitle&&g.jsx("p",{className:"mt-0.5 text-xs text-gray-500",children:r.subtitle})]})]})})}const nu=ue.forwardRef(({activities:r},c)=>{const[,f]=ue.useState(0);ue.useEffect(()=>{const m=setInterval(()=>f(y=>y+1),3e4);return()=>clearInterval(m)},[]);const s=su(),h=r.filter(m=>"time"in m).find(m=>tn(m.time)>s),v=h?tn(h.time)-s:null,S=v!==null?v<=5?"text-red-500":v<=10?"text-orange-500":"text-gray-400":"text-gray-400";return g.jsxs("div",{ref:c,"data-time-indicator":!0,className:"relative my-6",children:[g.jsxs("div",{className:"flex items-center -mr-3 sm:-mr-4",children:[g.jsx("div",{className:"h-2.5 w-2.5 shrink-0 rounded-full bg-blue-500"}),g.jsx("div",{className:"h-0.5 flex-1 bg-blue-500"})]}),g.jsx("span",{className:"absolute left-4 -top-5 font-mono text-xs font-semibold text-blue-500",children:Mp()}),v!==null&&g.jsxs("span",{className:`absolute right-0 -top-5 text-xs ${S}`,children:["Next activity starts in ",g.jsx("span",{className:"font-semibold",children:Dp(v)})]})]})});nu.displayName="TimeIndicator";function Nh({collapsed:r,children:c}){return g.jsx("div",{"data-collapsed":r,"aria-hidden":r,className:"grid transition-[grid-template-rows,opacity,margin-bottom] duration-300 ease-in-out",style:{gridTemplateRows:r?"0fr":"1fr",opacity:r?0:1,marginBottom:r?0:"0.5rem"},children:g.jsx("div",{className:"overflow-hidden",children:c})})}function zp({activities:r,runGroups:c,isToday:f,selectedGroups:s,hidePast:d}){const h=ue.useRef(null),[,v]=ue.useState(0);ue.useEffect(()=>{if(!f)return;const j=setInterval(()=>v(M=>M+1),6e4);return()=>clearInterval(j)},[f]),ue.useEffect(()=>{if(!f)return;const j=setTimeout(()=>{var M;(M=h.current)==null||M.scrollIntoView({behavior:"smooth",block:"center"})},150);return()=>clearTimeout(j)},[f]);const S=su(),m=r.flatMap(j=>{if(j.type!=="session")return[j];if(s.length===0)return[j];const M=j.onTrack.filter(oe=>s.includes(oe)),Y=(j.inClass??[]).filter(oe=>s.includes(oe));return M.length===0&&Y.length===0?[]:[{...j,onTrack:M,inClass:Y}]}),y=m.map(j=>j.type!=="break"&&d&&f&&tn(j.time)<S);m.forEach((j,M)=>{if(j.type!=="break")return;const Y=m.slice(0,M).some((oe,V)=>oe.type!=="break"&&!y[V]);y[M]=!Y});const k=[],R=[];m.forEach((j,M)=>{j.type!=="break"&&(k.push(M),R.push(j.time))});const{index:H}=f?_p(R,S):{index:-1},L=H===-1?-1:k[H],q=f?m.findIndex(j=>j.type!=="break"&&tn(j.time)>S):-1,K=f&&q===-1&&m.length>0,ie=m.length>0&&y.every(Boolean);let U;return g.jsxs("div",{className:"flex flex-col pb-10",children:[m.length>0&&g.jsx(Nh,{collapsed:!ie,children:g.jsxs("div",{className:"flex flex-col items-center gap-1 rounded-2xl border border-gray-200 bg-white px-6 py-10 text-center shadow-sm",children:[g.jsx("p",{className:"text-sm font-medium text-gray-500",children:"That's a wrap for today"}),g.jsx("p",{className:"text-xs text-gray-400",children:"Every activity on today's schedule has already happened."})]})}),m.map((j,M)=>{const Y=M===L,oe=f&&j.type!=="break"&&!Y&&tn(j.time)<S;let V=null;!y[M]&&j.type==="session"&&j.sessionNumber!==void 0&&j.sessionNumber!==U&&(U=j.sessionNumber,V=g.jsxs("div",{className:"mt-5 mb-1 text-xs font-bold uppercase tracking-widest text-gray-400",children:["Session ",j.sessionNumber]}));const B=j.type==="break"?g.jsxs("div",{className:"flex items-center gap-2 py-1",children:[g.jsx("div",{className:"h-px flex-1 bg-gray-200"}),g.jsx("span",{className:"text-xs text-gray-400 italic",children:j.label}),g.jsx("div",{className:"h-px flex-1 bg-gray-200"})]}):j.type==="session"?g.jsx(Rp,{activity:j,runGroups:c,past:oe}):g.jsx(Op,{activity:j,past:oe});return g.jsxs(Nh,{collapsed:y[M],children:[M===q&&g.jsx(nu,{ref:h,activities:m}),V,B]},M)}),K&&g.jsx(nu,{ref:h,activities:m})]})}function Up({groups:r,selected:c,onChange:f}){const[s,d]=ue.useState(!1),h=m=>f(c.includes(m)?c.filter(y=>y!==m):[...c,m]),v=c.length===0||c.length===r.length,S=r.filter(m=>c.includes(m.id));return g.jsxs("div",{className:"relative",children:[g.jsxs("button",{onClick:()=>d(m=>!m),className:"flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-3 py-1.5 text-sm shadow-sm transition-colors hover:border-gray-400",children:[v?g.jsx("span",{className:"text-gray-700",children:"All run groups"}):g.jsx("div",{className:"flex items-center gap-1",children:S.map(m=>g.jsx(ao,{group:m,size:"sm"},m.id))}),g.jsx(gg,{size:14,className:"text-gray-400"})]}),s&&g.jsxs(g.Fragment,{children:[g.jsx("div",{className:"fixed inset-0 z-10",onClick:()=>d(!1)}),g.jsxs("div",{className:"absolute left-0 top-full z-20 mt-1 min-w-[180px] rounded-xl border border-gray-200 bg-white p-1 shadow-xl",children:[r.map(m=>g.jsxs("button",{onClick:()=>h(m.id),className:"flex w-full items-center justify-between rounded-lg px-3 py-2 hover:bg-gray-50",children:[g.jsx(ao,{group:m,size:"md"}),c.includes(m.id)&&g.jsx(lo,{size:14,className:"text-blue-500"})]},m.id)),g.jsx("div",{className:"mt-1 border-t border-gray-100 pt-1",children:g.jsx("button",{onClick:()=>{f([]),d(!1)},className:"w-full rounded-lg px-3 py-2 text-left text-sm text-gray-400 hover:bg-gray-50",children:v?"All selected":"Clear filter"})})]})]})]})}function eo(r){return r.days.reduce((c,f)=>f.date<c?f.date:c,r.days[0].date)}function Ch(r){return r.days.reduce((c,f)=>f.date>c?f.date:c,r.days[0].date)}function bg(r,c=Fn()){return r.days.some(f=>f.date===c)?"live":r.days.every(f=>f.date>c)?"upcoming":"past"}function ru(r,c=Fn()){const f=[],s=[],d=[];for(const h of r){const v=bg(h,c);v==="live"?f.push(h):v==="upcoming"?s.push(h):d.push(h)}return f.sort((h,v)=>eo(h).localeCompare(eo(v))),s.sort((h,v)=>eo(h).localeCompare(eo(v))),d.sort((h,v)=>Ch(v).localeCompare(Ch(h))),{live:f,upcoming:s,past:d}}const jp="/hpde/assets/msrc-3-1-C8L2cRhZ.svg",Hp="/hpde/assets/msrc-1-7-CT_mRfuQ.svg",Lp="/hpde/assets/msrc-1-3-9yXe4Q7S.svg",Bp="/hpde/assets/ecr-2-7-CgJhLgMd.svg",Gp={"msrc-3-1":jp,"msrc-1-7":Hp,"msrc-1-3":Lp,"ecr-2-7":Bp};function wg({trackId:r,size:c=28,muted:f=!1,tone:s="default",className:d}){const h=r?Gp[r]:void 0,S=`inline-grid shrink-0 place-items-center rounded-lg ${s==="selected"?"bg-blue-100 text-blue-600":"bg-gray-100 text-gray-700"} ${f?"opacity-70":""} ${d??""}`.trim(),m=c+8;return g.jsx("span",{className:S,style:{width:m,height:m},"aria-hidden":"true",children:h?g.jsx("span",{className:"block bg-current",style:{width:c,height:c,WebkitMaskImage:`url(${h})`,maskImage:`url(${h})`,WebkitMaskSize:"contain",maskSize:"contain",WebkitMaskRepeat:"no-repeat",maskRepeat:"no-repeat",WebkitMaskPosition:"center",maskPosition:"center"}}):g.jsx("svg",{viewBox:"0 0 32 32",width:c,height:c,className:`block ${s==="selected"?"text-blue-300":"text-gray-300"}`,fill:"none",children:g.jsx("path",{d:"M6 16 C6 9 12 5 17 6 C24 7 27 12 27 17 C27 23 22 27 15 27 C9 27 6 22 6 16 Z",stroke:"currentColor",strokeWidth:2.5,strokeLinecap:"round",strokeDasharray:"3 3"})})})}function Sg(){return g.jsxs("span",{className:"ml-2 inline-flex shrink-0 items-center gap-1 rounded-full bg-green-100 px-1.5 py-px text-[9px] font-semibold uppercase tracking-wide text-green-700",children:[g.jsx("span",{className:"h-1 w-1 rounded-full bg-green-700 animate-pulse"}),"Live"]})}function Dr({event:r,active:c,isLive:f,onClick:s}){return g.jsxs("button",{onClick:s,className:`flex w-full items-center gap-3 rounded-lg px-4 py-2.5 text-left ${c?"bg-blue-50":"hover:bg-gray-50"}`,children:[g.jsx(wg,{trackId:r.trackId,size:28,tone:c?"selected":"default"}),g.jsxs("div",{className:"min-w-0 flex-1",children:[g.jsxs("div",{className:"flex items-center gap-1.5",children:[g.jsx("span",{className:"truncate text-sm font-semibold text-gray-900",children:r.name}),f&&g.jsx(Sg,{})]}),g.jsx("div",{className:"truncate text-xs text-gray-400",children:ou(r)})]}),c&&g.jsx(lo,{size:14,className:"text-blue-500 ml-1 shrink-0"})]})}function kr({label:r}){return g.jsx("div",{className:"px-4 pb-1 pt-2 text-[10px] font-semibold uppercase tracking-wide text-gray-400",children:r})}function Yp({events:r,active:c,onChange:f}){const[s,d]=ue.useState(!1),{live:h,upcoming:v,past:S}=ru(r),m=bg(c)==="live";return g.jsxs("div",{className:"relative flex min-w-0 flex-col items-center",children:[g.jsxs("button",{onClick:()=>d(y=>!y),className:"group flex min-w-0 max-w-full flex-col items-center",children:[g.jsxs("span",{className:"flex max-w-full items-center gap-1 min-w-0",children:[g.jsx("h1",{className:"truncate text-xl font-bold text-gray-900 leading-tight",children:c.name}),m&&g.jsx(Sg,{}),g.jsx(gg,{size:16,className:"shrink-0 text-gray-400 group-hover:text-gray-600 transition-colors"})]}),g.jsx("span",{className:"max-w-full truncate text-center text-sm text-gray-500",children:ou(c)})]}),s&&g.jsxs(g.Fragment,{children:[g.jsx("div",{className:"fixed inset-0 z-10",onClick:()=>d(!1)}),g.jsxs("div",{className:"absolute left-1/2 top-full z-20 mt-2 min-w-[280px] -translate-x-1/2 rounded-xl border border-gray-200 bg-white p-1 shadow-xl",children:[h.length>0&&g.jsxs(g.Fragment,{children:[g.jsx(kr,{label:"Live"}),h.map(y=>g.jsx(Dr,{event:y,active:y.id===c.id,isLive:!0,onClick:()=>{f(y),d(!1)}},y.id))]}),g.jsx(kr,{label:"Upcoming"}),v.length>0?v.map(y=>g.jsx(Dr,{event:y,active:y.id===c.id,isLive:!1,onClick:()=>{f(y),d(!1)}},y.id)):g.jsx("div",{className:"px-4 py-2 text-xs text-gray-400",children:"None"}),S.length>0&&g.jsxs(g.Fragment,{children:[g.jsx("div",{className:"my-2 border-t border-gray-100",role:"separator"}),g.jsx(kr,{label:"Past"}),S.map(y=>g.jsx(Dr,{event:y,active:y.id===c.id,isLive:!1,onClick:()=>{f(y),d(!1)}},y.id))]})]})]})]})}const qp=[{id:"schedule",label:"Schedule"},{id:"notes",label:"My notes"},{id:"info",label:"Info"}];function Vp({active:r,onChange:c}){return g.jsx("div",{role:"tablist","aria-label":"Event section",className:"flex gap-1 rounded-lg bg-white border border-gray-200 p-1 shadow-sm",children:qp.map(f=>{const s=f.id===r;return g.jsx("button",{role:"tab","aria-selected":s,"aria-controls":`event-tabpanel-${f.id}`,id:`event-tab-${f.id}`,onClick:()=>c(f.id),className:`flex-1 rounded-md py-2 text-sm font-medium transition-colors ${s?"bg-gray-900 text-white":"text-gray-500 hover:text-gray-800"}`,children:f.label},f.id)})})}function Xp(r){try{return new URL(r).hostname.replace(/^www\./,"")}catch{return r}}function Ip(r){const c=r.trim().toLowerCase();return c==="clockwise"?"CW (clockwise)":c==="counter-clockwise"||c==="counterclockwise"?"CCW (counter-clockwise)":r}function Qp(r,c){return[r,c&&Ip(c)].filter(Boolean).join(" ")}function zl({icon:r,label:c,subtitle:f,children:s}){return g.jsxs("div",{className:"grid grid-cols-[124px_1fr] items-center gap-3 border-b border-gray-100 py-3 last:border-b-0",children:[g.jsxs("span",{className:"flex items-center gap-3 text-[13px] font-medium text-gray-500",children:[g.jsx(r,{size:14,className:"shrink-0 text-gray-400"}),c]}),g.jsxs("span",{className:"text-sm text-gray-900 tabular-nums break-words",children:[s,f&&g.jsx("span",{className:"mt-0.5 block text-xs font-normal text-gray-400",children:f})]})]})}function Kp({event:r}){var S;const[c,f]=ue.useState(!1),s=Cp(r.days),d=Qp(r.configuration,r.direction),h=!!((S=r.scheduleScans)!=null&&S.length);return s||r.organizer||r.track||d||r.link||h||r.mapImage?g.jsxs(g.Fragment,{children:[g.jsxs("div",{className:"pl-1",children:[s&&g.jsx(zl,{icon:hg,label:"Dates",children:s}),r.organizer&&g.jsx(zl,{icon:Ep,label:"Organizer",children:r.organizer}),r.track&&g.jsx(zl,{icon:vp,label:"Location",subtitle:r.city,children:r.track}),d&&g.jsx(zl,{icon:Tp,label:"Track config",children:d}),r.link&&g.jsx(zl,{icon:pp,label:"Event page",children:g.jsxs("a",{href:r.link,target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-1 font-medium text-blue-500 hover:underline",children:[Xp(r.link),g.jsx(hp,{size:12,className:"text-gray-400"})]})})]}),r.mapImage&&g.jsxs("div",{className:"mt-6 pl-1",children:[g.jsxs("h3",{className:"mb-2 flex items-center gap-3 text-[13px] font-medium text-gray-500",children:[g.jsx(bp,{size:14,className:"shrink-0 text-gray-400"}),"Track map"]}),g.jsxs("button",{type:"button",onClick:()=>f(!0),"aria-label":"Expand track map",className:"group relative block w-full overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm",children:[g.jsx("img",{src:r.mapImage,alt:`${r.name} track map`,className:"block w-full h-auto"}),g.jsx("span",{className:"absolute right-2 top-2 inline-grid h-8 w-8 place-items-center rounded-full bg-black/50 text-white backdrop-blur-sm transition-colors group-hover:bg-black/70",children:g.jsx(wp,{size:16})})]})]}),h&&g.jsxs("div",{className:"mt-6 pl-1",children:[g.jsxs("h3",{className:"mb-2 flex items-center gap-3 text-[13px] font-medium text-gray-500",children:[g.jsx(mp,{size:14,className:"shrink-0 text-gray-400"}),"Original schedule"]}),g.jsx("div",{className:"grid grid-cols-2 gap-2 sm:grid-cols-3",children:r.scheduleScans.map((m,y)=>g.jsx("a",{href:m,target:"_blank",rel:"noopener noreferrer",children:g.jsx("img",{src:m,alt:`Original schedule scan ${y+1}`,className:"aspect-[3/4] w-full rounded-lg border border-gray-200 object-cover"})},m))})]}),c&&r.mapImage&&g.jsxs("div",{role:"dialog","aria-modal":"true","aria-label":`${r.name} track map`,onClick:()=>f(!1),className:"fixed inset-0 z-[60] flex items-center justify-center bg-black/90 p-4",children:[g.jsx("button",{onClick:()=>f(!1),"aria-label":"Close map",className:"absolute right-4 top-4 inline-grid h-10 w-10 place-items-center rounded-full bg-white/10 text-white transition-colors hover:bg-white/20",children:g.jsx(iu,{size:20})}),g.jsx("img",{src:r.mapImage,alt:`${r.name} track map`,className:"max-h-full max-w-full rounded-lg object-contain"})]})]}):g.jsx("p",{className:"text-sm text-gray-400",children:"No details for this event yet."})}function Zp({checked:r,onChange:c,label:f}){return g.jsxs("label",{style:{display:"flex",alignItems:"center",gap:"8px",cursor:"pointer",userSelect:"none"},children:[f&&g.jsx("span",{style:{fontSize:"14px",color:"#4b5563"},children:f}),g.jsx("button",{type:"button",role:"switch","aria-checked":r,onClick:c,style:{position:"relative",display:"inline-block",width:"44px",height:"24px",borderRadius:"12px",backgroundColor:r?"#000000":"#d1d5db",border:"none",cursor:"pointer",padding:0,flexShrink:0,transition:"background-color 0.2s ease",WebkitTapHighlightColor:"transparent"},children:g.jsx("span",{style:{position:"absolute",top:"2px",left:r?"22px":"2px",width:"20px",height:"20px",borderRadius:"50%",backgroundColor:"white",boxShadow:"0 1px 4px rgba(0,0,0,0.25)",transition:"left 0.2s ease",display:"block"}})})]})}const Zn=72,Jp=110;function Ah({children:r,disabled:c,scrollContainerRef:f}){const[s,d]=ue.useState(0),[h,v]=ue.useState("idle"),S=ue.useRef(null),m=ue.useRef(0);ue.useEffect(()=>{if(c)return;const H=()=>{const ie=f==null?void 0:f.current;return ie?ie.scrollTop:window.scrollY},L=ie=>{H()===0&&(S.current=ie.touches[0].clientY)},q=ie=>{if(S.current===null)return;const U=ie.touches[0].clientY-S.current;if(U<=0){S.current=null;return}ie.preventDefault();const j=U<Zn?U:Zn+(U-Zn)*.25;m.current=Math.min(j,Jp),d(m.current),v("pulling")},K=()=>{S.current!==null&&(S.current=null,m.current>=Zn?(v("refreshing"),d(Zn*.75),setTimeout(()=>window.location.reload(),600)):(v("releasing"),d(0),m.current=0,setTimeout(()=>v("idle"),250)))};return document.addEventListener("touchstart",L,{passive:!0}),document.addEventListener("touchmove",q,{passive:!1}),document.addEventListener("touchend",K),document.addEventListener("touchcancel",K),()=>{document.removeEventListener("touchstart",L),document.removeEventListener("touchmove",q),document.removeEventListener("touchend",K),document.removeEventListener("touchcancel",K)}},[c,f]);const y=h==="releasing"||h==="refreshing",k=Math.min(s/Zn,1),R=s>=Zn;return g.jsxs(g.Fragment,{children:[g.jsx("div",{className:"pointer-events-none fixed inset-x-0 z-50 flex justify-center",style:{top:-44,transform:`translateY(${s}px)`,transition:y?"transform 0.25s ease":"none"},children:g.jsx("div",{className:`flex h-8 w-8 items-center justify-center rounded-full bg-white shadow-md ${R?"text-blue-500":"text-gray-400"}`,children:g.jsx(xp,{size:16,className:h==="refreshing"?"animate-spin":"",style:h!=="refreshing"?{transform:`rotate(${k*270}deg)`}:void 0})})}),g.jsx("div",{style:{transform:`translateY(${s}px)`,transition:y?"transform 0.25s ease":"none"},children:r})]})}function Fp({groups:r}){const c=r.filter(f=>f.description);return c.length===0?null:g.jsxs("div",{className:"mt-2 rounded-2xl border border-gray-200 bg-white p-4 shadow-sm",children:[g.jsx("div",{className:"mb-2 text-xs font-bold uppercase tracking-widest text-gray-400",children:"Legend"}),g.jsx("ul",{className:"flex flex-col gap-1.5",children:c.map(f=>g.jsxs("li",{className:"flex items-center gap-2 text-sm text-gray-700",children:[g.jsx("span",{className:`h-3 w-3 shrink-0 rounded-full ${f.bgClass}`,"aria-hidden":"true"}),g.jsx("span",{className:"font-medium text-gray-900",children:f.label}),g.jsx("span",{className:"text-gray-400",children:"·"}),g.jsx("span",{children:f.description})]},f.id))})]})}const _h=`// HPDE track-day schedule — iOS Home Screen widget for Scriptable.
...
`,cu="/hpde/assets/msrc-1-7-D9G0r_nf.jpg",Ey={...Ba("2026-09-11_msrc-1-7",Ty),mapImage:cu},Ny=`# SCCA at MSRC 1.7 CW
...
`,Dy="/hpde/assets/msrc-3-1-BsOP6CK2.png",ky={...Ba("2025-11-07_msrc-3-1",My),mapImage:Dy},Ry=`# TDE at ECR 2.7
...
`,Oy="/hpde/assets/ecr-BW_3Ndfh.png",zy={...Ba("2026-05-30_ecr-2-7",Ry),mapImage:Oy},Uy=`# Test Event
