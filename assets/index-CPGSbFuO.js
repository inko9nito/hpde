 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const $0=yt.forwardRef(({color:s="currentColor",size:f=24,strokeWidth:h=2,absoluteStrokeWidth:o,className:c="",children:d,iconNode:b,...T},g)=>yt.createElement("svg",{ref:g,...W0,width:f,height:f,stroke:s,strokeWidth:o?Number(h)*24/Number(f):h,className:lg("lucide",c),...T},[...b.map(([y,z])=>yt.createElement(y,z)),...Array.isArray(d)?d:[d]]));/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
